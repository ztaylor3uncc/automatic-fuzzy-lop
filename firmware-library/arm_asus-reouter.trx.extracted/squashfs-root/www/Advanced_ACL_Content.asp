...
<div>&nbsp;</div>
<div class="formfonttitle"><#275#> - <#279#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#1347#></div>
...
<td colspan="2" style="color:#FFCC00;height:30px;" align="center"><#358#></td>
</tr>
<tr>
<th width="30%"><#1483#></th>
<td>
<input type="radio" name="enable_mac" value="0" onclick="enable_macMode();"><#140#>
<input type="radio" name="enable_mac" value="1" onclick="enable_macMode();"><#139#>
</td>
</tr>
<tr id="mac_filter_mode">
<th width="30%" >
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,1);"><#1633#></a>
</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullWLMACList(this);" title="<#2438#>">
