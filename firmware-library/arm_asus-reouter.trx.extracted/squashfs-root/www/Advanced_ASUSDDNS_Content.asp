...
document.getElementById("DDNSName").value = "<#113#>";
}
else{
...
document.getElementById("ddns_hostname_x").value = "<#113#>";
}
...
show_alert_block("<#1950#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
function cleandef(){
if(document.form.DDNSName.value == "<#113#>")
...
document.getElementById("le_desc").innerHTML = "<#1983#>";
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="button_gen" onclick="open_upload_window();" type="button" value="<#1297#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
if(orig_le_enable != "0")
document.getElementById("cert_details").style.display = "";
...
document.getElementById("cert_status").innerHTML = "<#2747#>";
}
else
document.getElementById("cert_status").innerHTML = "<#1287#>";
}
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#286#> - <#291#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#1965#></div>
<div class="formfontdesc" style="margin-top:-8px;"><#2213#></div>
<div class="formfontdesc" id="wan_ip_hide2" style="color:#FFCC00; display:none;"><#1966#></div>
<div class="formfontdesc" id="wan_ip_hide3" style="color:#FFCC00; display:none;"><#1967#></div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2008#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<input type="hidden" name="wl_gmode_protection_x" value="<% nvram_get("wl_gmode_protection_x"); %>">
<tr>
<th><#1964#></th>
<td>
<input type="radio" value="1" name="ddns_enable_x" onClick="change_cert_method();show_cert_details();return change_common_radio(this, 'LANHostConfig', 'ddns_enable_x', '1')" <% nvram_match("ddns_enable_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="ddns_enable_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_enable_x', '0')" <% nvram_match("ddns_enable_x", "0", "checked"); %>><#139#>
</td>
</tr>
<tr>
<th id="ddns_wan_unit_th"><#2949#></th>
<td id="ddns_wan_unit_td">
<select name="ddns_wan_unit" class="input_option">
<option class="content_input_fd" value="-1" <% nvram_match("ddns_wan_unit", "-1","selected"); %>><#114#></option>
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1472#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1478#></option>
</select>
</td>
</tr>
<tr>
...
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1975#></a>
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1313#></a>
</td>
</tr>
<tr id="ddns_hostname_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#1971#></a></th>
<td>
...
<th><#1982#></th>
<td>
<input type="radio" value="1" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '1')" <% nvram_match("ddns_wildcard_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '0')" <% nvram_match("ddns_wildcard_x", "0", "checked"); %>><#139#>
</td>
</tr>
<tr id="check_ddns_field" style="display:none;">
<th><#1324#></th>
<td>
<input type="radio" value="1" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "0", "checked"); %>><#139#>
</td>
</tr>
<tr style="display:none;">
<th><#1325#></th>
<td>
<input type="text" lass="input_3_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2064#>
</td>
</tr>
<tr style="display:none;">
<th><#1978#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#1976#>" /></td>
</tr>
<tr id="https_cert" style="display:none;">
<th><#1314#></th>
<td>
<span id="le_crypt" style="color:#FFF;display:none;">
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1315#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1317#>
<span id="self_signed" style="color:#FFF;">
<input type="radio" value="0" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "0", "checked"); %>><#714#>
</span>
...
<th>Server Certificate</th><td>
<div style="display:table-row;">
<div style="display:table-cell;"><#613#> :</div>
<div id="cert_status" style="display:table-cell; padding-left:10px;"></div>
</div>
<div style="display:table-row;">
<div style="display:table-cell;">Issued to :</div> <div id="issueTo" style="display:table-cell; padding-left:10px;"></div>
</div>
<div style="display:table-row;">
<div style="display:table-cell;">Issued by :</div> <div id="issueBy" style="display:table-cell; padding-left:10px;"></div>
</div>
<div style="display:table-row;">
<div style="display:table-cell;">Expires on :</div> <div id="expireOn" style="display:table-cell; padding-left:10px;"></div>
</div>
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1203#>" />
</div>
</td>
</tr>
</table>
<div class="apply_gen">
<input class="button_gen" onclick="apply_eula_check();" type="button" value="<#148#>" />
</div>
</td>
</tr>
</tbody>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;">Import your own certificate</div><div class="formfontdesc" style="margin-left: 15px;">Upload a certificate issued by a certification authority here. Your private key and SSL certificate is necessary.</div><div class="Upload_item">
...
<div style="display:table-cell;"><input class="button_gen" type="button" onclick="hide_upload_window();" id="cancelBtn" value="<#150#>"></div>
<div style="display:table-cell; padding-left: 5px;"><input class="button_gen" type="button" onclick="upload_cert_key();" value="<#1287#>"></div>
</div>
</div>
</form>
</body>
