...
document.getElementById("machine_name").innerHTML = "<#710#>";
if(get_manage_type(PROTOCOL)){
document.getElementById("loginMethod").innerHTML = "<#825#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#824#>";
...
confirm_str_off= "<#1238#>"; //"<#1240#>"+ By Viz 2011.09
confirm_str_on = "<#1242#>";
}
else if(protocol == "ftp"){
status = this.FTP_status;
confirm_str_off = "<#1239#>";
confirm_str_on = "<#1243#>";
}
switch(status){
case 1:
...
account_group_menu_code += '<div class="noAccount" id="noAccount"><#2204#></div>\n'
else{
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 6)?"<#771#>":"<#743#>";
}
...
<tr>
<td align="left">
<span class="formfonttitle"><#292#> - <#294#></span>
</td>
<td align="right">
...
<div class="formfontdesc"><#1685#></div>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,1);"><#2471#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,9);"><#2465#></a>
</th>
<td>
<select name="ftp_lang" class="input_option">
<option value="CN" <% nvram_match("ftp_lang", "CN", "selected"); %>>GBK</option><!-- <#2468#> -->
<option value="TW" <% nvram_match("ftp_lang", "TW", "selected"); %>>Big5</option><!-- <#2467#> -->
<option value="EN" <% nvram_match("ftp_lang", "EN", "selected"); %>>UTF-8</option><!--<#2466#>-->
<option value="RU" <% nvram_match("ftp_lang", "RU", "selected"); %>><#2469#></option>
<option value="CZ" <% nvram_match("ftp_lang", "CZ", "selected"); %>><#2470#></option>
</select>
</td>
</tr>
</table>
...
<td><div id="createAccountBtn" title="<#771#>"></div></td>
<td><div id="deleteAccountBtn" title="<#1328#>"></div></td>
<td><div id="modifyAccountBtn" title="<#2141#>"></div></td>
</tr>
<tr id="trPMGroup" style="display:none;">
<td>
<select name="" id="user_type" class="input_option" onchange="switchUserType(this.value);">
<option value="group"><#2250#></option>
<option value="account"><#2252#></option>
</select>
</td>
</tr>
</table>
...
<table align="right">
<tr>
<td><div id="createFolderBtn" title="<#773#>"></div></td>
<td><div id="deleteFolderBtn" title="<#1331#>"></div></td>
<td><div id="modifyFolderBtn" title="<#2144#>"></div></td>
</tr>
</table>
</td>
</tr>
...
<input name="changePermissionBtn" id="changePermissionBtn" type="button" value="<#157#>" class="button_gen_long_dis" disabled="disabled">
</div>
</td>
</tr>
</table>
