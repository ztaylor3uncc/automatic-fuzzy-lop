...
add_option(document.form.KnownApps, "<#607#>", 0, 1);
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#1853#></td></tr>';
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#297#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#276#></div>
<div class="formfontdesc"><#1601#></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,6);"><#1608#></a></th>
<td>
<input type="radio" value="1" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '1')" <% nvram_match("fw_enable_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '0')" <% nvram_match("fw_enable_x", "0", "checked"); %>><#139#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,7);"><#1606#></a></th>
<td>
<input type="radio" value="1" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '1')" <% nvram_match("fw_dos_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '0')" <% nvram_match("fw_dos_x", "0", "checked"); %>><#139#>
</td>
</tr>
<tr>
<th align="right"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,1);"><#1646#></a></th>
<td>
<select name="fw_log_x" class="input_option">
<option value="none" <% nvram_match("fw_log_x", "none","selected"); %>><#714#></option>
<option value="drop" <% nvram_match("fw_log_x", "drop","selected"); %>><#2220#></option>
<option value="accept" <% nvram_match("fw_log_x", "accept","selected"); %>><#2217#></option>
<option value="both" <% nvram_match("fw_log_x", "both","selected"); %>><#2218#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,5);"><#1650#></a></th>
<td>
<input type="radio" value="1" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '1')" <% nvram_match("misc_ping_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '0')" <% nvram_match("misc_ping_x", "0", "checked"); %>><#139#>
</td>
</tr>
...
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#302#></div>
<div>
<div class="formfontdesc"><#1657#></div>
<div class="formfontdesc"><#1658#></div>
</div>
...
<th><#1656#></th>
<td>
<input type="radio" value="1" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "0", "checked"); %>><#139#>
</td>
</tr>
<tr>
<th><#1852#></th>
...
<thead>
<tr>
<td colspan="7"><#1659#>&nbsp;(<#2021#>&nbsp;128)</td>
</tr>
</thead>
<tr>
<th><#1192#></th>
<th><#1660#></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#1847#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#1626#></a></th>
<th><#1849#></th>
<th><#2020#></th>
</tr>
<tr>
