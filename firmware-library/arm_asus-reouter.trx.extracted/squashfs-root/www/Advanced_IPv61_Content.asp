...
var ipv6_service_opt = new Array( new Array("<#1200#>", "disabled"),
new Array("Native", "dhcp6"),
new Array("<#1886#>", "other"),
...
alert("<#2808#> "+document.form.ipv61_dhcp_start_start.value);
...
<div class="formfontdesc"><#1927#></div>
...
<option value="disabled" <% nvram_match("ipv61_service", "disabled", "selected"); %>><#1200#></option>
<option value="dhcp6" <% nvram_match("ipv61_service", "dhcp6", "selected"); %>>Native</option>
<option value="other" <% nvram_match("ipv61_service", "other", "selected"); %>><#1886#></option>
...
<option class="content_input_fd" value="eth" <% nvram_match("ipv61_ifdev", "eth","selected"); %>><#2947#></option>
</select>
</td>
</tr>
<tr style="display:none;"><th>DHCP-PD</th>
<td>
<input type="radio" name="ipv61_dhcp_pd" class="input" value="1" onclick="showInputfield2('ipv61_dhcp_pd', this.value);" <% nvram_match("ipv61_dhcp_pd", "1","checked"); %>><#3074#>
<input type="radio" name="ipv61_dhcp_pd" class="input" value="0" onclick="showInputfield2('ipv61_dhcp_pd', this.value);" <% nvram_match("ipv61_dhcp_pd", "0","checked"); %>><#1200#>
</td>
</tr>
<tr style="display:none;"><th>Accept Default Route</th> <td>
<input type="radio" name="_ipv61_accept_defrtr" class="input" value="1" <% nvram_match("ipv61_accept_defrtr", "1","checked"); %>><#3074#>
<input type="radio" name="_ipv61_accept_defrtr" class="input" value="0" <% nvram_match("ipv61_accept_defrtr", "0","checked"); %>><#1200#>
</td>
</tr>
...
<th><#1870#></th>
<td>
<input type="radio" name="ipv61_6rd_dhcp" class="input" value="1" onclick="showInputfield2('ipv61_6rd_dhcp', this.value);" <% nvram_match("ipv61_6rd_dhcp", "1","checked"); %>><#3074#>
<input type="radio" name="ipv61_6rd_dhcp" class="input" value="0" onclick="showInputfield2('ipv61_6rd_dhcp', this.value);" <% nvram_match("ipv61_6rd_dhcp", "0","checked"); %>><#1200#>
</td>
</tr>
<tr style="display:none;">
<th><#1872#></th>
...
<th><#211#></th>
<td>
<input type="radio" name="ipv61_dnsenable" class="input" value="1" onclick="showInputfield2('ipv61_dnsenable', this.value);" <% nvram_match("ipv61_dnsenable", "1","checked"); %>><#3074#>
<input type="radio" name="ipv61_dnsenable" class="input" value="0" onclick="showInputfield2('ipv61_dnsenable', this.value);" <% nvram_match("ipv61_dnsenable", "0","checked"); %>><#1200#>
...
<th><#1488#></th>
<td>
<input type="radio" name="_ipv6_radvd" class="input" value="1" <% nvram_match("ipv6_radvd", "1","checked"); %>><#3074#>
<input type="radio" name="_ipv6_radvd" class="input" value="0" <% nvram_match("ipv6_radvd", "0","checked"); %>><#1200#>
</td>
</tr>
</table>
<div class="apply_gen">
