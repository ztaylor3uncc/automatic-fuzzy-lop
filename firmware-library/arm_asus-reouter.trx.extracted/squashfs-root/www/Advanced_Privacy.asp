...
document.getElementById("asus_eula_title").innerHTML = "<#93#>";
document.getElementById("alexa_ifttt").style.display = "none";
}
else if(alexa_support && !ifttt_support){
document.getElementById("asus_eula_title").innerHTML = "<#92#>";
document.getElementById("alexa_ifttt").innerHTML = "<#99#>";
}
}
else
...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle"><#303#> - <#3373#></div>
<div style="margin:10px 0 10px 5px;"><img src="/images/New_ui/export/line_export.png"></div>
<div id="privacy_desc" style="font-size:14px; margin: 20px 10px auto 10px; display:none;"><#76#></div>
<div id="asus_eula" class="eula_withdraw" style="display:none;">
<div class="eula_withdraw_title" id="asus_eula_title"><#91#></div>
<div class="eula_withdraw_content">
<div><#94#></div>
<div><#95#></div>
<div style="margin-top:5px;"><#96#>
<ol style="margin-top:0px;">
<li><#97#></li>
<li><#98#></li>
<li id="alexa_ifttt"><#100#></li>
</ol>
</div>
</div>
<div>
<input class="button_gen" style="margin-left: 305px; margin-bottom:10px;" name="asus_withdraw_btn" onclick="withdraw_eula('asus');" type="button" value="<#112#>"/>
</div>
</div>
<div id="tm_eula" class="eula_withdraw" style="display:none;">
<div class="eula_withdraw_title"><#108#></div>
<div class="eula_withdraw_content">
<div><#109#></div>
<div style="margin-top:5px;"><#110#>
<div><#106#></div>
<div><#107#></div>
</div>
</div>
<div>
<input class="button_gen" style="margin-left: 305px; margin-bottom:10px;" name="asus_withdraw_btn" onclick="withdraw_eula('tm');" type="button" value="<#112#>"/>
</div>
</div>
</td>
</tr>
