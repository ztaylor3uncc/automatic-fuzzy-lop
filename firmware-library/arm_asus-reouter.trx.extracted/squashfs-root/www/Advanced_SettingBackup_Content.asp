...
showtext(document.getElementById("loading_block2"), "<#2423#>");
...
showtext(document.getElementById("loading_block2"), "<#2444#>");
document.getElementById('loading_block3').style.display = "none";
...
/*if(findasus_support){
document.getElementById('loading_block3').innerHTML = "<div><#328#></div>";
}else{*/
document.getElementById('loading_block3').innerHTML = "<div><#264#>.<#245#></div>";
}
},
success: function(){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#303#> - <#308#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#2457#></div>
<table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th width="25%" align="right">
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#2451#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="button_gen" onclick="restoreRule('restore');" type="button" value="<#1292#>" name="action1" />
</div>
...
<span><label for="restoreInit"><#2454#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#2456#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="button_gen" onclick="saveSetting('Router');" type="button" value="<#2456#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#2461#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1323#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#2460#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="button_gen" onclick="selectSetting();" value="<#1297#>"/>
</td>
