...
show_menu();
if(ctf_disable == 1){
document.getElementById("ctfLevelDesc").innerHTML = "<#2151#>";
}
else{
if(ctf_fa_mode == '2')
document.getElementById("ctfLevelDesc").innerHTML = "<#2153#>";
else
document.getElementById("ctfLevelDesc").innerHTML = "<#2152#>";
}
if(lacp_support){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#282#> - <#2543#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#2547#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th><#1918#></th>
<td>
<select name="jumbo_frame_enable" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("jumbo_frame_enable", "0","selected"); %>><#3075#></option>
<option class="content_input_fd" value="1" <% nvram_match("jumbo_frame_enable", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
<tr id="ctf_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,2);"><#2149#></a></th>
<td>
<select name="ctf_disable_force" class="input_option">
<option class="content_input_fd" value="1" <% nvram_match("ctf_disable", "1","selected"); %>><#3075#></option>
<option class="content_input_fd" value="0" <% nvram_match("ctf_disable", "0","selected"); %>><#114#></option>
</select>
&nbsp
...
<td>
<input type="radio" name="gro_disable_force" value="0" <% nvram_match("gro_disable_force", "0", "checked"); %>><#140#>
<input type="radio" name="gro_disable_force" value="1" <% nvram_match("gro_disable_force", "1", "checked"); %>><#139#>
</td>
</tr>
<tr id="lacp_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,1);"><#2159#></a></th>
<td>
<select name="lacp_enabled" class="input_option" onchange="check_bonding_policy(this);">
<option class="content_input_fd" value="0" <% nvram_match("lacp_enabled", "0","selected"); %>><#3075#></option>
<option class="content_input_fd" value="1" <% nvram_match("lacp_enabled", "1","selected"); %>><#3074#></option>
</select>
<div id="lacp_desc" style="display:none"><span id="lacp_note"><#2161#></span><div>
</td>
</tr>
...
<option value="0"><#1274#></option>
<option value="1"><#2546#></option>
