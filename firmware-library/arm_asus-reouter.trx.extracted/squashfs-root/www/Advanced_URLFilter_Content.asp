...
<div>&nbsp;</div>
<div class="formfonttitle"><#297#> - <#298#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#1643#></div>
<!--div class="formfontdesc"><#1612#></div-->
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(9,1);"><#1642#></th>
<td>
<input type="radio" value="1" name="url_enable_x" <% nvram_match("url_enable_x", "1", "checked"); %>><#1278#>
<input type="radio" value="0" name="url_enable_x" <% nvram_match("url_enable_x", "0", "checked"); %>><#1275#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(9,3);"><#1619#></a></th>
<td>
<select name="url_mode_x" class="input_option" onChange="">
<option class="content_input_fd" value="0" <% nvram_match( "url_mode_x", "0", "selected"); %>><#1131#></option>
<option class="content_input_fd" value="1" <% nvram_match( "url_mode_x", "1", "selected"); %>><#2990#></option>
</select>
</td>
</tr>
</table>
