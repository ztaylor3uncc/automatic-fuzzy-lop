...
code +='<tr><td style="color:#FC0;" colspan="6"><#1853#></td></tr>';
else{
for(var i = 0; i < vpnc_clientlist_array.length; i += 1) {
if(vpnc_clientlist_array[i] != "") {
...
code +="<td width='10%'><img title='<#147#>' src='/images/InternetScan.gif'></td>";
else if(client_state == 2)
code +="<td width='10%'><img title='<#142#>' src='/images/checked_parentctrl.png' style='width:25px;'></td>";
else if(client_errno == 1 || client_errno == 2 || client_errno == 3)
code +="<td width='10%'><div title='<#2840#>' class='vpnc_ipconflict_icon'></div></td>";
else if(client_errno == 4 || client_errno == 5 || client_errno == 6)
code +="<td width='10%'><img title='<#434#>' src='/images/button-close2.png' style='width:25px;'></td>";
else //Stop connection
code +="<td width='10%'><img title='<#144#>' src='/images/button-close2.png' style='width:25px;'></td>";
}
else{
...
code += '<td width="25%"><input class="button_gen" type="button" onClick="connect_Row(this, \'disconnect\');" id="disonnect_btn" value="<#1273#>" style="padding:0 0.3em 0 0.3em;" >';
}
else{ //OpenVPN is not connecting
code += '<td width="10%"><input class="remove_btn" type="button" onclick="del_Row(this, \'vpnc\');" value=""/></td>';
code += '<td width="25%"><input class="button_gen" type="button" onClick="connect_Row(this, \'vpnc\');" id="Connect_btn" name="Connect_btn" value="<#1265#>" style="padding:0 0.3em 0 0.3em;" >';
}
}
else{
if( vpnc_proto == document.form.vpnc_proto.value.toUpperCase()
...
case '1' :
code +='<td width="10%" title="<#142#>"><img src="/images/checked_parentctrl.png" style="width:25px;"></td>';
break;
case '2' :
code +='<td width="10%" title="<#1248#>"><img src="/images/InternetScan.gif" style="width:25px;"></td>';
break;
case '3' :
code +='<td width="10%" title="<#144#>"><img src="/images/button-close2.png" style="width:25px;cursor:pointer;"></td>';
break;
}
}
else {
...
code +='<td width="25%">';
if(ipsec_profilelist_arraylist[i][38] == 0) {
code += '<input class="button_gen" type="button" onClick="connect_Row_IPSec(this, \''+ipsec_profilelist_arraylist[i][0]+'\', \'active\');" value="<#1265#>">';
}
else {
code += '<input class="button_gen" type="button" onClick="connect_Row_IPSec(this, \''+ipsec_profilelist_arraylist[i][0]+'\', \'deactivate\');" value="<#1273#>">';
...
alert(document.ipsec_form.ipsec_remote_gateway.value + " <#232#>");
return false;
}
}
...
if(!is_ipv4 && !is_ipv6) {
alert(existSubnetObj.value + "<#232#>");
...
<option value="auto"><#114#></option>
<option value="-mppc"><#2201#></option>
...
<input class="button_gen" type="button" onclick="cancel_add_rule();" id="cancelBtn" value="<#150#>">
<input class="button_gen" type="button" onclick="addRow_Group(10,save_flag, idx_tmp);" value="<#1287#>">
</div>
</div>
...
<td bgcolor="#4D595D" valign="top">
<div>&nbsp;</div>
<div class="formfonttitle">VPN - <#2942#></div>
...
<thead>
<tr>
<td colspan="6" id="VPNServerList" style="border-right:none;height:22px;"><#133#> <span id="rules_limit" style="color:#FFFFFF"></span></td>
</tr>
</thead>
<tr>
<th width="10%" style="height:30px;"><#378#></th>
<th><div><#1825#></div></th>
<th width="15%"><div><#467#></div></th>
<th width="10%"><div><#2347#></div></th>
<th width="10%"><div><#1272#></div></th>
<th width="25%"><div><#143#></div></th>
</tr>
</table>
<div id="vpnc_clientlist_Block"></div>
<div class="apply_gen">
<input class="button_gen_long" onclick="Add_profile(10)" type="button" value="<#2939#>">
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div class="formfonttitle"><#2935#></div>
<div class="formfontdesc">
<#2936#>
<br>
<#2937#>
...
<option value="1" selected><#276#></option>
<option value="2"><#274#></option>
</select>
</td>
</tr>
</table>
...
<label for='ipsec_remote_gateway_ip' id="ipsec_remote_gateway_ip_label"><#2920#></label>
...
<label for='ipsec_remote_gateway_ddns' id="ipsec_remote_gateway_ddns_label"><#1986#></label>
</td>
</tr>
...
<th><#2893#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#2885#>">
</td>
</tr>
...
<thead>
<tr>
<td id="td_network_title" colspan="2">Network - <#2540#></td>
</tr>
</thead>
...
<thead>
<tr>
<td colspan="2">Advanced Settings - <#2895#></td>
</tr>
</thead>
...
<th><#2898#></th>
<td>
<input type="radio" name="ipsec_exchange" class="input" value="1" onchange="changeExchangeMode();"><#1349#>
<input type="radio" name="ipsec_exchange" class="input" value="0" onchange="changeExchangeMode();" checked><#2899#>
<div id="exchange_mode_hint" style="color:#FC0;margin:5px 0px;"><#2904#></div>
</td>
</tr>
...
<span style="color:#FC0">(120~172800) <#2425#></span>
</td>
</tr>
<tr id="tr_adv_ike_isakmp" style="display:none;">
<th>IKE / ISAKMP Port</th>
<td>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#1200#></label>
...
<label for='ipsec_dead_peer_detection_clear' id="ipsec_dead_peer_detection_clear_label"><#1270#></label>
...
<label for='ipsec_dead_peer_detection_hold' id="ipsec_dead_peer_detection_hold_label"><#2922#></label>
...
<label for='ipsec_dead_peer_detection_restart' id="ipsec_dead_peer_detection_restart_label"><#2923#></label>
</td>
</tr>
...
<span style="color:#FC0">(10~900) <#2425#></span>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="2">Advanced Settings - <#2896#></td>
</tr>
</thead>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(33,1);"><#2917#></a></th>
<td>
...
<div style="color:#FC0;margin:10px 0px;"><#2903#></div>
</div>
<div style="margin-top:15px;width:100%;text-align:center;">
<input id="cancelBtn_ipsec" class="button_gen" type="button" onclick="cancel_ipsec_profile_panel();" value="<#150#>">
<input class="button_gen" type="button" onclick="save_ipsec_profile_panel();" value="<#1288#>">
</div>
</td>
</tr>
</table>
...
<input class="button_gen" onclick="ImportOvpn(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" type="button" value="<#1297#>" />
...
<input type="checkbox" id="cbManualImport" class="input" onclick="manualImport(this.checked)"><#2882#>
</div>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input id="importCA" class="button_gen" onclick="startImportCA(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" type="button" value="<#1297#>" />
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnCertForm.submit();" type="button" value="<#1297#>" />
</td>
</tr>
</table>
</form>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnKeyForm.submit();" type="button" value="<#1297#>" />
</td>
</tr>
</table>
</form>
...
<td>
<input type="file" name="file" class="input" style="color:#FC0;*color:#000;"><br>
<input class="button_gen" onclick="setTimeout('ovpnFileChecker();',2000);document.openvpnStaticForm.submit();" type="button" value="<#1297#>" />
</td>
</tr>
</table>
</form>
...
<th><#268#></th>
<td>
<input class="button_gen" onclick="document.getElementById('manualFiled_panel').style.display='';" type="button" value="<#2347#>">
</td>
</tr>
</table>
...
<tr>
<td>
<div class="description_down"><#2869#></div>
</td>
</tr>
<tr>
<td>
<div style="margin-left:30px; margin-top:10px;">
<p><#2860#> <span style="color:#FC0;">----- BEGIN xxx ----- </span>/<span style="color:#FC0;"> ----- END xxx -----</span> <#2861#>
<p><#2862#>
</div>
...
<input class="button_gen" type="button" onclick="cancel_Key_panel();" value="<#150#>">
<input class="button_gen" type="button" onclick="saveManual(document.vpnclientForm.vpnc_openvpn_unit_edit.value);" value="<#1288#>">
</div>
</td>
</tr>
</table>
...
<div style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
<input class="button_gen" type="button" onclick="cancel_add_rule();" id="cancelBtn_openvpn" value="<#150#>">
<input class="button_gen" onclick='addOpenvpnProfile();' type="button" value="<#1287#>">
</div>
</div>
<div id="footer"></div>
</body>
