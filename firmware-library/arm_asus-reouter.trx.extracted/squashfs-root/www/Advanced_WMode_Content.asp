...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1286#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code +='<tr><td style="color:#FFCC00;"><#1853#></td>';
}
else{
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1096#></div>';
}
else{
...
document.getElementById("check_mac").innerHTML="<br><br><#248#>";
...
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<br><br><#216#>";
document.getElementById("check_mac").style.display = "";
return false;
}else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#275#> - <#278#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#3032#></div>
<div class="formfontdesc" style="color:#FFCC00;"><#781#><#3033#></div>
<div class="formfontdesc"><#3034#>
<ol>
<li><#3035#></li>
<li><#3036#></li>
<li><#3037#></li>
...
<div id="wl_bw_hint" style="font-size:13px;font-family: Arial, Helvetica, sans-serif;color:#FC0;margin-left:28px;"><#3039#></div>
<div id="wl_ch_hint" style="font-size:13px;font-family: Arial, Helvetica, sans-serif;color:#FC0;margin-left:28px;"><#3040#></div>
...
<td id="repeaterModeHint_desc" colspan="2" style="color:#FFCC00;height:30px;" align="center"><#358#></td>
</tr>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#3085#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#3086#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#3087#></option>
</select>
</td>
</tr>
...
<td>
<input type="radio" value="1" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "0", "checked"); %>><#139#>
</td>
</tr>
</table>
...
<td colspan="4"><#3056#>&nbsp;(<#2021#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#3056#></th>
<th class="edit_table" width="20%"><#2020#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2428#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<div class="apply_gen">
<input class="button_gen" id="submitBtn" onclick="applyRule()" type="button" value="<#148#>" />
</div>
</td>
</tr>
</tbody>
