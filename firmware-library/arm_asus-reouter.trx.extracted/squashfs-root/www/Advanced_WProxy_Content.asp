...
<div>&nbsp;</div>
<div class="formfonttitle"><#275#> - <#2993#></div>
...
<th><a><#2992#></a></th>
<td>
<input type="radio" name="wifipxy_enable_2" class="input" value="1" onclick="enable_wifipxy('1')" <% nvram_match("wlc0_wifipxy", "1", "checked"); %>><#140#>
<input type="radio" name="wifipxy_enable_2" class="input" value="0" onclick="enable_wifipxy('0')" <% nvram_match("wlc0_wifipxy", "0", "checked"); %>><#139#>
