...
<br>
<br>
<div class="feedback_info_0"><#1586#></div>
<br>
</div>
...
<#1564#>
<br>
<#1565#> : ( <a href="mailto:xdsl_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top" style="color:#FFCC00;">xdsl_feedback@asus.com </a>) <#1566#>
...
<#1564#>
<br>
<#1565#> : ( <a href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top" style="color:#FFCC00;">router_feedback@asus.com </a>) <#1566#>
And download <span onClick="get_feedback_tarball();" style="text-decoration: underline; color:#FFCC00; cursor:pointer;">this debug file</span> and add as email attachment.
<br>
</div>
...
<br>
<div class="feedback_info_1">We are working hard to improve the firmware of <#710#> and your feedback is very important to us. We will use your feedbacks and comments to strive to improve your ASUS experience.</div>
<br>
</div>
...
<input class="button_gen" onclick="redirect();" type="button" value="<#264#>"/>
</div>
</td>
</tr>
</tbody>
