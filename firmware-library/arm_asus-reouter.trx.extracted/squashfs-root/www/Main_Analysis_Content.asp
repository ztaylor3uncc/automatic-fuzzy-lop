...
document.getElementById("cmdDesc").innerHTML = "<#2192#>";
}
else if(_val == "traceroute"){
document.getElementById("pingCNT_tr").style.display = "none";
document.getElementById("cmdDesc").innerHTML = "<#2195#>";
}
else{
document.getElementById("pingCNT_tr").style.display = "none";
document.getElementById("cmdDesc").innerHTML = "<#2189#>";
}
update_ntool_unit();
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2180#> - <#2176#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc" id="cmdDesc"><#2192#></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wans_ntool_unit", "0","selected"); %>><#1472#></option>
<option class="content_input_fd" value="1" <% nvram_match("wans_ntool_unit", "1","selected"); %>><#1478#></option>
</select>
</td>
</tr>
<tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2434#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<div class="apply_gen">
<span><input class="button_gen_long" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2185#>"></span>
