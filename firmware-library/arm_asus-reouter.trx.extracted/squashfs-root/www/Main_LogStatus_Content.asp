...
<div>&nbsp;</div>
<div class="formfonttitle"><#629#> - <#309#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#1744#></div>
...
<tr>
<th><#1743#></a></th>
<td><span id="boot_days"></span> <#1312#> <span id="boot_hours"></span> <#1772#> <span id="boot_minutes"></span> <#2064#> <span id="boot_seconds"></span> <#2425#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#1993#></a></th>
<td>
...
<input class="button_gen" onclick="applySettings();" type="button" value="<#148#>" />
</form>
</td>
</tr>
</table>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1270#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1288#>" class="button_gen">
</form>
</td>
</tr>
</table>
