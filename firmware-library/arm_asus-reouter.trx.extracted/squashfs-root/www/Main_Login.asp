...
if(flag == 3){
document.getElementById("error_status_field").innerHTML ="* <#1916#>";
}
else if(flag == 7){
...
<div class="div_td"><#159#></div>
</div>
<div class="prod_madelName"><#710#></div>
<div id="login_filed">
<div class="p1 title_gap"><#608#></div>
<div id="name_title_ie" style="display:none;margin:20px 0 -10px 78px;" class="p1 title_gap"><#2791#></div>
<div class="title_gap">
<input type="text" id="login_username" name="login_username" tabindex="1" class="form_input" maxlength="20" autocapitalize="off" autocomplete="off" placeholder="<#2791#>">
</div>
<div id="password_title_ie" style="display:none;margin:20px 0 -20px 78px;" class="p1 title_gap"><#1788#></div>
<div class="password_gap">
<input type="password" name="login_passwd" tabindex="2" class="form_input" maxlength="16" placeholder="<#1788#>" autocapitalize="off" autocomplete="off">
</div>
<div class="error_hint" style="display:none;" id="error_status_field"></div>
<div class="button" onclick="login();"><#159#></div>
</div>
