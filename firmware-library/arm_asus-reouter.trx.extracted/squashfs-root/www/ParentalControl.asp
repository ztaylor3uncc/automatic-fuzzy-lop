...
<title id="web_title"><#709#> - <#359#></title>
...
document.getElementById('content_title').innerHTML = "<#999#> - <#2585#>";
document.getElementById('desc_title').innerHTML = "<#2234#>";
document.getElementById('web_title').innerHTML = "<#709#> - <#2585#>";
document.getElementById('PC_enable').innerHTML = "<#2232#>";
...
code +='<thead><tr><td colspan="4"><#1247#>&nbsp;(<#2021#>&nbsp;16)</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#2427#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#2427#></option>';
code += '<option value="0"><#1200#></option>';
code += '<option value="1"><#1377#></option>';
code += '<option value="2"><#1132#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1212#> (<#2304#>)</th>';
code +='<th width="20%"><#2241#></th>';
code +='<th width="20%"><#2020#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1200#></option>';
code += '<option value="1" selected><#1377#></option>';
code += '<option value="2"><#1132#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#2430#>">';
...
code += '<option value="0" ' + ((MULTIFILTER_ENABLE_row[i] == 0) ? "selected" : "") + '><#1200#></option>';
code += '<option value="1" ' + ((MULTIFILTER_ENABLE_row[i] == 1) ? "selected" : "") + '><#1377#></option>';
code += '<option value="2" ' + ((MULTIFILTER_ENABLE_row[i] == 2) ? "selected" : "") + '><#1132#></option>';
code += '</select>';
code += '</td>';
...
$("#mainTable").fadeIn();
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="applyRule(1);" value="<#148#>">';
showDropdownClientList('setClientIP', 'mac', 'all', 'ClientList_Block_PC', 'pull_arrow', 'all');
showclock();
}
function selectAll(){
...
code +='<tr><th style="width:40%;height:20px;" align="right"><#2242#></th>';
...
var code_temp = "";
code_temp = '<table><tr>';
code_temp += "<td><div style=\"font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0 10px\"><#1226#></div></td>";
code_temp += '<td><div>';
...
code_temp += '</select>';
code_temp += '</div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0 10px"><#2227#></div></td>';
code_temp += '<td><div style="width:90px;height:20px;background:#9CB2BA;"></div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0 10px"><#2229#></div></td>';
...
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="cancel_lantowan('+client+');" value="<#150#>">';
document.getElementById("ctrlBtn").innerHTML += '<input class="button_gen" type="button" onClick="saveto_lantowan('+client+');applyRule();" value="<#1287#>">';
...
code += "<span class=\"clicked\"><#2585#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#924#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#2585#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#924#></span>";
}
...
<tr>
<td align="left">
<div id="content_title" class="formfonttitle" style="width:400px"><#359#></div>
</td>
<td>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#924#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#2585#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<span id="desc_note" style="color:#FC0;"><#781#></span>
<ol style="color:#FC0;margin:-5px 0px 3px -18px;*margin-left:18px;">
<li><#2228#></li>
<li id="nat_desc"><#2230#></li>
</ol>
</td>
</tr>
</table>
...
<div id="svc_hint_div" style="display:none;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#197#></span></div>
