...
var category_title = ["", "<#756#>", "<#766#>","<#760#>", "<#768#>","<#755#>", "<#761#>"];
...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2058#> - <#763#>";
if(document.form.qos_enable.value == 1){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#2356#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#2355#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#271#> - <#2058#>";
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#232#>");
return false;
}
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2040#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5">Rule List&nbsp;(<#2021#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1247#>&nbsp;(<#2021#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#2427#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1090#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1090#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2194#></th>';
else
code += '<th style="width:330px"><#2194#></th>';
code += '<th style="width:130px"><#1406#></th>';
code += '<th style="width:130px"><#2748#></th>';
code += '<th style="width:90px"><#2020#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#913#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2430#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#1853#></td></tr>';
}
else{
...
<!--[if lte IE 6.5.]><script>alert("<#1068#>");</script><![endif]-->
</div>
...
<tr>
<div class="description_down"><#762#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#764#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#1770#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2030#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" id="btn_cancel_priority" type="button" onclick="cancel_priority_panel();" value="<#150#>">
<input class="button_gen" type="button" onclick="save_priority();" value="<#1288#>">
</div>
</td>
</tr>
</form>
...
<#1511#>
<ul>
<li id="function_int_desc"><#1512#></li>
<li id="function_trad_desc"><#1515#></li>
<li id="function_bandwidthLimit_desc"><#1513#></li>
</ul>
<#1514#>
</div>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1518#></div>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#2354#></th>
<td colspan="2">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#762#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a id="trad_type_link" class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1521#></label></a>
<input id="bw_limit_type" name="qos_type_radio" value="2" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a id="bw_limit_type_link" class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 7)"><label for="bw_limit_type"><#116#></label></a>
</td>
</tr>
<tr id="bandwidth_setting_tr" style="display:none">
<th><#1126#></th>
<td colspan="2">
<input id="auto" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="auto"><#115#></label>
<input id="manu" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="manu"><#268#></label>
</td>
</tr>
<tr id="wan_1_tr" style="display:none">
<th colspan=3><#1472#></th>
</tr>
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#2748#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1406#></a></th>
<td>
...
<tr>
<td height="30" align="left" valign="top" bgcolor="#4D595D">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#765#></div>
</td>
</tr>
</table>
...
<td width="10px"></td>
<td class="Quick_Setup_title" align="center"><#948#></td><td width="50px"></td>
<td class="Quick_Setup_title" align="center"><#949#></td><td width="50px"></td>
<td class="Quick_Setup_title" align="center"><#768#></td><td width="50px"></td>
<td class="Quick_Setup_title" align="center"><#1303#></td>
<td width="20px"></td>
</tr>
<tr height="40">
</tr>
...
<tr>
<td height="50" >
<div style=" *width:136px;margin-left:300px;" class="titlebtn" align="center" onClick="submitQoS();"><span><#148#></span></div>
</td>
</tr>
</table>
</td>
