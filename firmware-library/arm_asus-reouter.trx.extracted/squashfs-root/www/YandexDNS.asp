...
code +='<option value="1"'+(value == 1 ? "selected" : "")+'><#3213#></option>';
code +='<option value="2"'+(value == 2 ? "selected" : "")+'><#3215#></option>';
code +='<option value="0"'+(value == 0 ? "selected" : "")+'><#3211#></option>';
if (defmode)
code +='<option value="-1"'+(value == -1 ? "selected" : "")+'><#1201#></option>';
code += '</select>'
return code;
}
...
code +='<thead><tr><td colspan="5"><#1247#>&nbsp;(<#2021#>&nbsp;16)</td></tr></thead>';
code +='<tr><th width="3%" height="30px" title="<#2427#>"><input id="select_all" type="checkbox" onchange="selectRows_main(this);"></th>';
code +='<th width="38%"><#2242#></th>';
code +='<th width="19%"><#2240#></th>';
code +='<th width="15%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(27,1);"><#3210#></a></th>';
code +='<th width="10%"><#2020#></th></tr>';
code +='<tr><td style="border-bottom:2px solid #000;" title="<#3074#>/<#1200#>"><input type="checkbox" name="rule_enable" checked></td>';
...
<div>&nbsp;</div>
<div class="formfonttitle"><#3204#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div id="yadns_desc" style="margin-bottom:10px;">
<table width="700px" style="margin-left:25px;">
<tr>
<td>
<a href="<#3209#>" target="_blank"><img src="/images/New_ui/<#3208#>"></a>
</td>
<td>&nbsp;&nbsp;</td>
