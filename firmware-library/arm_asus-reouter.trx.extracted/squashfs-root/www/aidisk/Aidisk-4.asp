...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#2536#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#2537#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#2538#>\"");
break;
}
}
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#2539#></td>
</tr>
<tr>
...
<input type="button" id="finish" value="<#1279#>" class="button_gen">
</div>
</td>
</tr>
</table>
