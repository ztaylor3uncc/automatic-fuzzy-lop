...
showtext(document.getElementById("alert_msg2"),"*<#185#>");
...
showtext(document.getElementById("alert_msg2"),"*<#252#>");
...
<thead>
<tr>
<td colspan="2"><span style="color:#FFF"><#2141#>: </span><span style="color:#FFF" id="selected_account"></span><img src="../images/button-close.gif" onClick="parent.hidePop('OverlayMask');"></td>
</tr>
</thead>
<tbody>
<tr valign="middle">
<td height="30" colspan="2" class="hint_word"><#2139#></td>
</tr>
<tr>
<th><#821#>: </th>
<td>
...
<tr bgcolor="#E6E6E6">
<th colspan="2" align="right"><input id="Submit" type="button" class="button_gen" value="<#154#>"></th>
</tr>
</table>
</form>
</body>
