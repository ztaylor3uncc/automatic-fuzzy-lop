...
disk_list_array = { "info" : ["<#1365#>", "disk.asp"], "health" : ["<#1358#>", "disk_utility.asp"], "format" : ["<#1281#>", "disk_format.asp"]};
...
if(progressBar >= 5)
progressBar =5;
document.getElementById('scan_message').innerHTML = "<#1367#>";
}
...
progressBar = 15;
document.getElementById('scan_message').innerHTML = "<#1378#>";
}
...
progressBar = 40;
document.getElementById('scan_message').innerHTML = "<#1371#>";
}
...
progressBar = 90;
document.getElementById('scan_message').innerHTML = "<#1370#>";
}
else if(scan_status == 5 && stopScan == 0){
if(progressBar <= 90)
progressBar = 91;
document.getElementById('scan_message').innerHTML = "<#1363#>";
}
else{
...
clearTimeout(timer);
document.getElementById('scan_message').innerHTML = "<#1376#>";
...
<div class="font_style" style="margin-left:10px;margin-bottom:5px;margin-top:10px;"><#1361#></div>
<div >
...
<input id="btn_scan" type="button" class="button_gen" onclick="go_scan();" value="<#492#>">
<input id="btn_abort" type="button" class="button_gen" onclick="abort_scan();" value="<#150#>" style="display:none">
...
<tr>
<td class="list_bg">
<div class="font_style" style="margin-left:12px;margin-top:10px;"><#1375#></div>
<img style="margin-top:5px;margin-left:10px; *margin-top:-5px;" src="/images/New_ui/networkmap/linetwo2.png">
<div style="margin-left:10px;">
<table>
<tr class="font_style">
<td style="width:100px;">
<div style="margin-bottom:5px;" ><#1364#></div>
<select name="diskmon_freq" onchange="freq_change();" class="input_option">
<option value="0" <% nvram_match("diskmon_freq", "0", "selected"); %>><#1200#></option>
<option value="1" <% nvram_match("diskmon_freq", "1", "selected"); %>><#1368#></option>
<option value="2" <% nvram_match("diskmon_freq", "2", "selected"); %>><#1380#></option>
<option value="3" <% nvram_match("diskmon_freq", "3", "selected"); %>><#1360#></option>
</select>
</td>
<td >
<div id="date_field">
<div style="margin-bottom:5px;"><#1304#></div>
...
<td>
<div id="week_field">
<div style="margin-bottom:5px"><#1379#></div>
...
<td>
<div id="time_field">
<div style="margin-bottom:5px;"><#1377#></div>
...
<div style="margin-top:20px;margin-bottom:10px;" align="center">
<input type="button" class="button_gen" onclick="apply_schedule();" value="<#148#>">
