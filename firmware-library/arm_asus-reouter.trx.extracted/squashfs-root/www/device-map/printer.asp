...
<p class="formfonttitle_nwm"><#2326#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2332#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" id="monoP" style="width:138px;"><#2331#></p>
<input id="monoBtn" type="button" class="button_gen" value="<#3074#>" onclick="cleanTask();">
...
<li><#2324#></li>
<li>
<a id="faq" href="https://www.asus.com/support/FAQ/113988/" target="_blank" style="text-decoration:underline;"><#2331#> FAQ</a>
</li>
</ul>
</div>
</form>
