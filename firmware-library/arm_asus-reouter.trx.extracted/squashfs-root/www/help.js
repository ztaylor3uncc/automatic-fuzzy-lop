...
var clicked_help_string = "<#1764#> <a class=\"hintstyle\" style=\"background-color:#7aa3bd\"><#1765#></a> <#1766#>";
...
var title5_2 = 0;
if(itemNum == 50){
statusmenu ="<span><#489#></span>";
}
if(itemNum == 85){
statusmenu ="<span><#754#></span>";
}
else if(itemNum == 86){
statusmenu ="<span>For optimize online gaming process bandwidth including Diablo, WOW, Steam games and XBOX, ect.<br><#747#></span>"; /* untranslated */
}
else if(itemNum == 87){
statusmenu ="<span>For faster video streaming experience including Youtube, Netflix and Spotify, ect.<br><#748#></span>"; /* untranslated */
}
else if(itemNum == 88){
statusmenu ="<span><#769#><br><#750#></span>";
}
else if(itemNum == 89){
...
statusmenu ="<span><#747#></span>";
}
else if(itemNum == 92){
statusmenu ="<span><#748#></span>";
}
else if(itemNum == 93){
statusmenu ="<span><#749#></span>";
}
else if(itemNum == 94){
statusmenu ="<span><#750#></span>";
}
else if(itemNum == 95){
statusmenu ="<span><#751#></span>";
}
else if(itemNum == 96){
statusmenu ="<span><#752#></span>";
}
if(itemNum == 98){
var signal = parseInt(sim_signal);
if(isNaN(signal) || signal <= 0){
statusmenu += "<div class='StatusHint'><#2091#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#142#> <#1786#>: </div><span>" + modem_act_provider + "</span>";
}
else{
statusmenu += "<div class='StatusHint'><#167#></div>";
}
}
if(itemNum == 99){
if(sim_state == "1")
statusmenu += "<div class='StatusHint'><#2117#></div>";
else if(sim_state == "2"){
if( g3err_pin == "1" && pin_remaining_count < 3)
statusmenu += "<div class='StatusHint'>Wrong PIN code. Please input the correct PIN code.</div>";
else
statusmenu += "<div class='StatusHint'><#2084#></div>";
}
else if(sim_state == "3")
statusmenu += "<div class='StatusHint'><#2086#></div>";
else if(sim_state == "4")
statusmenu += "<div class='StatusHint'><#2085#></div>";
else if(sim_state == "5")
statusmenu += "<div class='StatusHint'><#2087#></div>";
else if(sim_state == "6")
statusmenu += "<div class='StatusHint'><#2136#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2116#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2114#></div>";
else
statusmenu += "<div><#2074#></div>";
}
if(itemNum == 24)
...
statusmenu += "<span><#982#></span>";
else if(itemNum == 17)
statusmenu += "<span><#981#></span>";
else if(itemNum == 16)
statusmenu += "<span><#980#></span>";
else if(itemNum == 15)
statusmenu += "<span><#979#></span>";
else if(itemNum == 14)
statusmenu += "<span><#978#></span>";
else if(itemNum == 13)
statusmenu += "<span><#977#></span>";
else if(itemNum == 12)
statusmenu += "<span><#976#></span>";
else if(itemNum == 11)
statusmenu += "<span><#975#></span>";
else if(itemNum == 10)
statusmenu += "<span><#974#></span>";
if(itemNum == 26)
statusmenu += "<span><#2360#></span>";
if(itemNum == "A"){
statusmenu = "<div class='StatusHint'><#762#> :</div>";
...
statusmenu += "<div class='StatusHint'><#1202#> :</div>";
lineDesc = ""; /* Untranslated */
var transform_dblog_service = function() {
var dblog_service = parseInt('<% nvram_get("dblog_service"); %>');
var dblog_service_mapping = ["", "Wi-Fi", "Download Master", "<#659#>", "AiMesh"];/* untranslated */
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2148#> :</div>";
lineDesc = ""; /* Untranslated */
...
remaining_time_str += "0" + " <#2425#> ";
return remaining_time_str;
}
if(days)
remaining_time_str += days + " <#1312#> ";
if(hours)
remaining_time_str += hours + " <#1772#> ";
if(minutes)
remaining_time_str += minutes + " <#2064#> ";
if(seconds)
remaining_time_str += seconds + " <#2425#> ";
return remaining_time_str;
};
...
wifiDesc = "<b>2.4GHz -</b> <#1201#>";
else
wifiDesc = "<b>2.4GHz -</b> <#1202#>";
if(wlan1_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1201#>";
else
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1202#>";
if(wlan2_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1201#>";
else
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1202#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else if(wl_info.band5g_support){
if(wlan0_radio_flag == "0" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1201#><br><br><b>5 GHz -</b><br><#1201#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1202#><br><br><b>5 GHz -</b><br><#1201#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1201#><br><br><b>5 GHz -</b><br><#1202#>";
else
wifiDesc = "<b>2.4GHz -</b><br><#1202#><br><br><b>5 GHz -</b><br><#1202#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else{
if(wlan0_radio_flag == "0")
...
statusmenu += "<div><#1278#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#2331#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
statusmenu += "<div><#1275#></div>";
}
if(statusmenu != "")
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2202#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2148#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1312#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#1772#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2064#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#1772#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2064#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2064#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2064#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#198#>:</div><span><#1275#></span>";
}
if(itemNum == 3){
var eLAN_str = "<#1503#>".replace(/WAN/, "LAN");
if(gobi_support){
if(dualWAN_support && wans_dualwan_array.indexOf("none") == -1){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#1503#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2283#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2126#>:</div>";
}
else
statusmenu = "<div class='StatusHint'><#2527#>:</div>";
}
else{
if(dualWAN_support && wans_dualwan_array.indexOf("none") == -1)
statusmenu = "<div class='StatusHint'><#1472#>:</div>";
else
statusmenu = "<div class='StatusHint'><#2527#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1503#> -</b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<b><#2283#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#296#> -</b><br>";
}
if(dualWAN_support && wans_dualwan_array.indexOf("none") == -1 ){
if(first_link_status == "1")
statusmenu += "<span><#683#></span>";
...
statusmenu += "<span><#612#></span>";
else
statusmenu += "<span><#142#></span>";
}
else{
if(sw_mode == 1){
...
if(wan0_enable == "0"){
if(gobi_support)
statusmenu += "<div><#2072#></div>";
else
statusmenu += "<div><#2763#></div>";
}
else{
if(sim_state != ""){
if(sim_state == "2"){
...
statusmenu += "<div><#2084#></div>";
}
else if(sim_state == "3")
statusmenu += "<div><#2086#></div>";
else if(sim_state == "4")
statusmenu += "<div><#2085#></div>";
else if(sim_state == "5")
statusmenu += "<div><#2087#></div>";
else if(sim_state == "6")
statusmenu += "<div><#2136#></div>";
else if(sim_state == "-1")
statusmenu += "<div><#2116#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2114#></div>";
else
statusmenu += "<div><#2074#></div>";
...
statusmenu += "<span><#167#></span>";
}
}
else{
if(wan0_enable == 0){
statusmenu += "<span><#2946#></span>";
}
else{
if(first_link_auxstatus == "1"){
if( wans_dualwan_array[0] == "lan"){
statusmenu += "<span><#1210#> : <#2283#> "+wans_lanport+"</span>";
}
else
statusmenu += "<span><#2351#></span>";
}
else if(first_link_sbstatus == "1")
statusmenu += "<span><#685#></span>";
else if(first_link_sbstatus == "2")
statusmenu += "<span><#580#></span>";
else if(first_link_sbstatus == "3")
statusmenu += "<span><#579#></span>";
else if(first_link_sbstatus == "4")
statusmenu += "<span><#688#></span>";
else if(first_link_sbstatus == "5")
statusmenu += "<span><#687#></span>";
else if(first_link_sbstatus == "6")
statusmenu += "<span>System error. <#2357#></span>";
else
statusmenu += "<span><#167#></span>";
}
}
...
statusmenu += "<span><#61#></span>";
else
statusmenu += "<span><#60#></span>";
}
}
}
}
...
statusmenu += "<div class='StatusHint'><br><#1503#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#2283#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2126#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1478#>:</div>";
if( wans_dualwan_array[1] == "wan")
statusmenu += "<b><#1503#> -</b><br>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<b><#2283#> "+wans_lanport+" -</b><br>";
...
statusmenu += "<span><#1066#> <#2357#></span>";
else
statusmenu += "<span><#167#></span>";
}
}
...
return "<#2148#> : <span>0</span> <#1772#> <span>0</span> <#2064#>";
else
return "<#2148#> : <span>"+EHours+"</span> <#1772#> <span>"+EMinutes+"</span> <#2064#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='priority_change();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#753#></span><br>";
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1516#></span>";
_caption = "<#762#>";
}
...
if(gobi_support){
statusmenu += "<#2112#></span>"
_caption = "<#2126#>";
}
else{
statusmenu += "<#1747#></span>"
_caption = "<#296#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1746#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1355#></span>";
else{
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1355#></span>";
else{
...
statusmenu = "<span class='StatusClickHint' onclick='top.location.href=\"/QIS_wizard.htm?flag=sitesurvey_rep\";' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#66#></span>";
}
else if(sw_mode == 4){
statusmenu = "<span class='StatusClickHint' onclick='top.location.href=\"/QIS_wizard.htm?flag=sitesurvey_mb\";' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#66#></span>";
}
...
statusmenu += "<#1480#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1356#></span>";
...
return overlib('<#164#>', HAUTO, VAUTO);
...
if (typeof ol_text=='undefined') var ol_text='<#803#>';
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#362#>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<#363#>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<#364#>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<#365#>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<#366#>"; }
}
else{
if (nScore >= 0 && nScore < 20) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#362#></a>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#363#></a>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#364#></a>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#365#></a>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#366#></a>"; }
}
