...
document.getElementById('NM_connect_title').innerHTML = "<#2225#> :";
}
else{
...
document.getElementById("first_wan_title").innerHTML = "<#1503#>:";
...
if(gobi_support)
document.getElementById("first_wan_title").innerHTML = "<#2126#>:";
else
document.getElementById("first_wan_title").innerHTML = "<#296#>:";
}
if(dualwan_second_if == 'wan')
document.getElementById("second_wan_title").innerHTML = "<#1503#>:";
...
if(gobi_support)
document.getElementById("second_wan_title").innerHTML = "<#2126#>:";
else
document.getElementById("second_wan_title").innerHTML = "<#296#>:";
}
}
...
if( ddns_enable == '0')
document.getElementById("ddnsHostName").innerHTML = '<a style="color:#FFF;text-decoration:underline;" href="/Advanced_ASUSDDNS_Content.asp?af=ddns_enable_x"><#1204#></a>';
else if(ddnsName == '')
document.getElementById("ddnsHostName").innerHTML = '<a style="color:#FFF;text-decoration:underline;" href="/Advanced_ASUSDDNS_Content.asp?af=DDNSName"><#2479#></a>';
...
if(sw_mode == "3"){
showtext(document.getElementById("NM_connect_status"), "<div style='margin-top:10px;'><#3084#></div>");
}
else if(sw_mode == "2"){
showtext(document.getElementById("NM_connect_title"), "<div style='margin-top:10px;'><#624#>:</div><br>");
}
else
return 0;
}
...
document.getElementById("clientNumber").innerHTML = "<#1686#>: <span id='_clientNumber'>" + num + "</span>";
}
...
dec_html_code += '<div class="style1"><strong id="diskUnmount'+ device.usbPath +'"><#1356#></strong></div>\n';
}
...
document.getElementById("deviceDec_" + device.usbPath).innerHTML = '<div style="margin:10px;"><#1278#></div>';
else
document.getElementById("deviceDec_" + device.usbPath).innerHTML = '<div style="margin:10px;"><#1275#></div>';
}
...
document.getElementById("changeIconTitle").innerHTML = "<#1271#>";
}
else {
$("#custom_image").slideUp("slow");
document.getElementById("changeIconTitle").innerHTML = "<#1268#>";
}
}
...
if(bwdpi_support) {
document.getElementById("time_scheduling_title").innerHTML = "<#2585#>";
}
...
switch (rssi_t) {
case 1:
connectModeTip = "<#598#>: <#363#>\n";
break;
case 2:
connectModeTip = "<#598#>: <#364#>\n";
break;
case 3:
connectModeTip = "<#598#>: <#365#>\n";
break;
case 4:
connectModeTip = "<#598#>: <#366#>\n";
break;
}
if(stainfo_support) {
if(clientObj.curTx != "")
...
connectModeTip += "<#740#>: " + clientObj.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
var opModeDes = ["none", "<#713#>", "<#350#>", "<#329#>", "<#337#>"];
...
code +='<tr><td style="color:#FFCC00;" colspan="4"><#1853#></td></tr>';
...
<div style="margin:200px auto; width:300px; background-color:#006699; color:#FFFFFF; line-height:150%; border:3px solid #FFF; padding:5px;"><#322#></p></div>
</div>
</noscript>
...
<thead>
<tr>
<td colspan="4">Client upload icon&nbsp;(<#2021#>&nbsp;100)</td>
</tr>
</thead>
<tr>
<th width="45%"><#1212#></th>
...
<input class="button_gen" type="button" onclick="btUserIconCancel();" value="<#150#>">
<input class="button_gen" type="button" onclick="btUserIconEdit();" value="<#1287#>">
...
<span title="Change to default client icon" class="IE8HACK" onclick="setDefaultIcon();"><#1274#></span>
<span id="changeIconTitle" class="IE8HACK" title="Change client icon" style="margin-left:10px;" onclick="show_custom_image();"><#1268#></span>
</div>
</td>
...
<td>
<div class="type18" onclick="select_image(this.className);" title="Printer"></div></td>
<td>
...
<span onmouseover="return overlib('Enable this button to block this device to access internet.');" onmouseout="return nd();"><#1214#></span></div>
<div class="left" style="cursor:pointer;float:right;" id="radio_BlockInternet_enable"></div>
</div>
<div class="clientList_line"></div>
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
<span id="time_scheduling_title" onmouseover="return overlib('Time Scheduling allows you to set the time limit for a client\'s network usage.');" onmouseout="return nd();"><#359#></span></div>
<div align="center" class="left" style="cursor:pointer;float:right;" id="radio_TimeScheduling_enable"></div>
<div id="internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#2585#>" onclick="redirectTimeScheduling();" ></div>
</div>
<div class="clientList_line"></div>
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
<span onmouseover="return overlib('Enable this button to bind specific IP with MAC Address of this device.');" onmouseout="return nd();"><#1216#></span></div>
...
<input class="button_gen" type="button" onclick="edit_delete();" id="deleteBtn" value="<#1272#>" style="display:none;">
<input class="button_gen" type="button" id="blockBtn" value="<#1132#>" title="<#1179#>" style="display:none;">
<script>
...
<input class="button_gen" type="button" onclick="closeClientDetailView();" value="<#150#>">
<input id="edit_confirm" class="button_gen" type="button" onclick="edit_confirm();" value="<#148#>">
...
<div id="first_wan_title"><#1472#>:</div>
...
<div id="second_wan_title"><#1478#>:</div>
...
<div>
<span id="NM_connect_title" style="font-size:12px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2527#>:</span>
<br>
<strong id="NM_connect_status" class="index_status" style="font-size:14px;"><#522#>...</strong>
</div>
...
<strong id="ddnsHostName" class="index_status" style="font-size:14px;"><#413#></strong>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#1816#>:</span>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2426#>: </span>
<br/>
<strong id="wl_securitylevel_span" class="index_status"></strong>
<img id="iflock">
</div>
<div id="mbModeContext" style="display:none">
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#304#>: </span>
<br/>
<br/>
<strong class="index_status"><#337#></strong>
</div>
</td>
</tr>
<tr>
...
<input type="button" class="button_gen" value="<#2802#>" style="margin-top:15px;" onClick="pop_clientlist_listview(true)">
