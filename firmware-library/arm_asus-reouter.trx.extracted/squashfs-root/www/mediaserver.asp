...
<link rel="icon" href="images/favicon.png"><title><#709#> - <#659#></title>
...
showtext(document.getElementById("alert_msg1"), "<#222#>");
...
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:15px;margin-left:30px;"><#710#></div>
</td>
<td>
<div style="width:240px;margin-top:14px;margin-left:135px;">
<table >
<tr>
<td><div id="createFolderBtn" class="createFolderBtn" title="<#773#>"></div></td>
<td><div id="deleteFolderBtn" class="deleteFolderBtn" title="<#1331#>"></div></td>
<td><div id="modifyFolderBtn" class="modifyFolderBtn" title="<#2144#>"></div></td>
</tr>
</table>
</div>
</td></tr></table>
...
<input class="button_gen" type="button" style="margin-left:27%;margin-top:18px;" onclick="cancel_folderTree();" value="<#150#>">
<input class="button_gen" type="button" onclick="confirm_folderTree();" value="<#1287#>">
</div>
</div>
...
<tr>
<td align="left">
<span class="formfonttitle"><#659#></span>
</td>
<td align="right">
<img onclick="go_setting('/APP_Installation.asp')" align="right" style="cursor:pointer;position:absolute;margin-left:-20px;margin-top:-30px;" title="<#272#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</td>
</tr>
</table>
</div>
<div style="margin:5px;"><img src="/images/New_ui/export/line_export.png"></div>
<div id="upnp_desc_id" class="formfontdesc"><#3403#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2203#></div>
</td>
</tr>
<tr>
<th><#1388#></th>
...
<th><#1390#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1391#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1389#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1389#>&nbsp;(<#2021#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1386#></th>
...
<tr>
<td width="45%">
<input id="PATH" type="text" class="input_30_table" value="" onclick="get_disk_tree();" autocorrect="off" autocapitalize="off" readonly="readonly"/" placeholder="<#607#>" >
</td>
<td width="40%">
...
<div class="apply_gen">
<input type="button" class="button_gen" onclick="applyRule()" value="<#148#>"/>
</div>
</td>
</tr>
<tr>
