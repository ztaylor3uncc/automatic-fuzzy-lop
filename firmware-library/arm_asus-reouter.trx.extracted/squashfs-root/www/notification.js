...
notification.desc[12] = "<#2083#>";
notification.action_desc[12] = "<#1110#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1103#>';
notification.action_desc[0] = '<#1110#>';
...
notification.desc[1] = '<#1104#>';
if(!live_update_support || !HTTPS_support){
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1111#></a>';
notification.clickCallBack[1] = "";
}
else{
notification.action_desc[1] = '<#1111#>';
...
notification.desc[2] = '<#1105#>';
notification.action_desc[2] = '<#1110#> (2.4GHz)';
...
notification.desc[3] = '<#1105#>';
notification.action_desc[3] = '<#1110#> (5 GHz)';
...
notification.ftp = 1;
notification.desc[4] = '<#1107#>';
notification.action_desc[4] = '<#690#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1106#>';
notification.action_desc[4] = '<#1110#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.desc[5] = '<#1109#>';
notification.action_desc[5] = '<#690#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1108#>';
notification.action_desc[5] = '<#1110#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[18] = '<#150#>';
...
notification.action_desc[8] = "<#1287#>";
...
notification.desc[16] = '<#199#><#200#><#201#><#202#>';
...
notification.desc[15] = '<#3222#>';
notification.action_desc[15] = '<#3223#>';
