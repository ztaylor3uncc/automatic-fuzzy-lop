...
banner_code +='<div style="margin-top:13px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#710#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:13px 0 0 160px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#638#></div></div></a>\n';
}
...
banner_code +='<div style="margin-top:13px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#710#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:25px; *width:136px;" class="titlebtn" align="center"><span><#638#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#138#></span></div></a>\n';
}
...
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#305#>:</sapn><span class="title_link" style="text-decoration: none;" id="op_link"><a href="/Advanced_OperationMode_Content.asp" style="color:white"><span id="sw_mode_span" style="text-decoration: underline;"></span></a></span>\n';
}
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#194#></sapn><a href="/Advanced_FirmwareUpgrade_Content.asp" style="color:white;"><span id="firmver" class="title_link"></span></a>\n';
...
banner_code +='<div style="padding:5px 0 5px 15px;font-size:14px;color:#BDBDBD"><#1100#></div>';
banner_code +='</div>';
banner_code +='</div>';
...
banner_code +='<div style="padding-left: 30px;"><a href="'+Android_app_link+'" target="_blank"><div style="width:172px;font-size:24px;font-weight:bold;text-decoration:underline"><#3378#></div></a></div>';
}
else{
...
banner_code += "<#2083#>";
banner_code +='</div>';
banner_code +="<span><input style=\"margin-left:30px;\" type=\"checkbox\" name=\"stop_show_chk\" id=\"stop_show_chk\"><#2124#></input></span>";
...
footer_code +='<div align="center" class="copyright"><#192#></div><br>';
...
footer_code += '<td width="20" align="right"><div id="bottom_help_icon" style="margin-right:3px;"></div></td><td width="110" id="bottom_help_title" align="left"><#1763#> & <#2541#></td>';
...
var model_name_supportsite = supportsite_model(support_site_modelid, hw_ver); // @ /js/support_site.js
footer_code += "<td width=\"335\" id=\"bottom_help_link\" align=\"left\"><a style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\" href=\"https://www.asus.com"+ href_lang +"Networking/"+ model_name_supportsite + tracing_path_Manual +"\" target=\"_blank\"><#2033#></a>&nbsp|&nbsp<a style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\" href=\"https://www.asus.com"+ href_lang +"Networking/" + model_name_supportsite + tracing_path_Utility +"\" target=\"_blank\"><#2799#></a>";
footer_code += '&nbsp|&nbsp<a id="registration_link" target="_blank" href="https://account.asus.com/" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2338#></a>';
if(dsl_support && feedback_support){
footer_code += '&nbsp|&nbsp<a id="fb_link" href="/Advanced_Feedback.asp" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2053#></a>';
}
...
footer_code += '&nbsp|&nbsp<a id="fb_link" href="'+location_href+'" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2053#></a>';
}
footer_code += '</td>';
...
document.getElementById("sw_mode_span").innerHTML = "<#713#>";
else if(sw_mode == "2"){
if(wlc_express == 1)
document.getElementById("sw_mode_span").innerHTML = "<#352#>";
else if(wlc_express == 2)
document.getElementById("sw_mode_span").innerHTML = "<#354#>";
else
document.getElementById("sw_mode_span").innerHTML = "<#350#>";
}
else if(sw_mode == "3")
document.getElementById("sw_mode_span").innerHTML = "<#329#>";
else if(sw_mode == "4")
document.getElementById("sw_mode_span").innerHTML = "<#337#>";
else
...
code +='<td><span id="proceeding_main_txt"><#265#></span><span id="proceeding_txt" style="color:#FFFFCC;"></span></td>\n';
code +='</tr>\n';
code +='</table>\n';
...
document.getElementById('selected_lang').innerHTML = "<#735#>";
}
...
document.getElementById("NM_connect_status").innerHTML = "<#142#>";
...
if(location.pathname == "/" || location.pathname == "<% abs_index_page(); %>"){
document.getElementById("NM_connect_status").innerHTML = "<#167#>";
...
return "<#2285#> HTTP LAN port.";
else if(_val == '<% nvram_get("dm_http_port"); %>')
return "<#2285#> Download Master.";
else if(_val == '<% nvram_get("webdav_http_port"); %>')
return "<#2285#> Cloud Disk.";
