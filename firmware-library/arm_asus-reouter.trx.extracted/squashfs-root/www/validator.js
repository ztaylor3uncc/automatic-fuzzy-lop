...
document.getElementById("check_ip_input").innerHTML="<#232#>";
...
alert(document.form.wan_ipaddr_x.value + " <#232#>");
document.form.wan_ipaddr_x1.focus();
return false;
}
...
alert(document.form.wan_ipaddr_x1.value + "<#220#>");
document.form.wan_ipaddr_x1.focus();
document.form.wan_ipaddr_x1.select();
return false;
}
...
if(!groupChar(c)){
alert('<#237#> '+o.value.charAt(i)+' <#238#>');
o.focus();
o.select();
return false;
}
