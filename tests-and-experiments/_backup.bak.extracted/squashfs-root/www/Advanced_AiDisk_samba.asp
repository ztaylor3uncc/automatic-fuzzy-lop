...
document.getElementById("loginMethod").innerHTML = "<#832#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#831#>";
...
<tr>
<td align="left">
<span class="formfonttitle"><#292#> - <#293#><span id="clouddiskstr"> / <#1227#></span></span>
</td>
<td align="right">
...
<div class="formfontdesc"><#2420#></div>
<div class="formfontdesc"><#781#>&nbsp;<#2421#></div>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,2);"><#2463#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,3);"><#2476#></a>
</th>
<td>
...
<option class="content_input_fd" value="0" <% nvram_match("usb_fs_ntfs_sparse", "0","selected"); %>><#3075#></option>
<option class="content_input_fd" value="1" <% nvram_match("usb_fs_ntfs_sparse", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
</table>
