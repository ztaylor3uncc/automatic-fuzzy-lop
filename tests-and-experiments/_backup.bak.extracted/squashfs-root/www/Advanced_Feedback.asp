...
ptypelist = new Array();
ptypelist.push(["<#607#> ...", "No_selected"]);
ptypelist.push(["<#1583#>", "Setting_Problem"]);
ptypelist.push(["<#1539#>", "Connection_or_Speed_Problem"]);
ptypelist.push(["<#1531#>", "Compatibility_Problem"]);
ptypelist.push(["<#1587#>", "Translated_Suggestion"]);
ptypelist.push(["<#761#>", "Other_Problem"]);
...
desclist = new Array();
url_group = new Array();
desclist.push(["<#607#> ...","No_selected"]);
url_group.push(["select"]);//false value
if(ptype == "Setting_Problem"){
desclist.push(["<#381#>","QIS"]);
url_group.push(["QIS"]);
desclist.push(["<#273#>","Network Map"]);
url_group.push(["index"]);
desclist.push(["<#198#>","Guest Network"]);
url_group.push(["Guest_network"]);
desclist.push(["<#999#>","AiProtection"]);
url_group.push(["AiProtection"]);
desclist.push(["<#762#>","Adaptive QoS"]); //5
url_group.push(["AdaptiveQoS"]);
desclist.push(["<#1521#>","Traditional QoS"]);
url_group.push(["AiProtection"]);
desclist.push(["<#271#>","<#2628#>"]);
url_group.push(["TrafficMonitor"]);
desclist.push(["<#359#>","Parental Ctrl"]);
url_group.push(["ParentalControl"]);
desclist.push(["<#272#>","USB Application"]);
...
desclist.push(["<#307#>","FW update"]);
url_group.push(["FirmwareUpgrade"]);
}
else if(ptype == "Connection_or_Speed_Problem"){
desclist.push(["<#1540#>","Wireless speed"]);
desclist.push(["<#1541#>","Wired speed"]);
desclist.push(["<#1543#>","Unstable connection"]);
desclist.push(["<#1542#>","Router reboot"]);
}
else if(ptype == "Compatibility_Problem"){
desclist.push(["<#1534#>","Compatible Problem"]);
desclist.push(["<#1536#>","Compatible Problem"]);
desclist.push(["<#1532#>","Compatible Problem"]);
desclist.push(["<#1537#>","Compatible Problem"]);
desclist.push(["<#1538#>","Compatible Problem"]);
desclist.push(["<#1533#>","Compatible Problem"]);
desclist.push(["<#1535#>","Compatible Problem"]);
}
else if(ptype == "Translated_Suggestion"){
desclist.splice(0,1);
desclist.push(["<#1588#>","Translation"]);
}
else{ //Other_Problem
desclist.splice(0,1);
desclist.push(["<#761#>","others"]);
}
...
if(value) {
if(allUsbStatus.search("storage") == "-1"){
alert("USB disk required in order to store the debug log, please plug-in a USB disk to <#710#> and Enable DSL Line Diagnostic again.");/*untranslated*/
...
var dblog_service_mapping = ["", "Wi-Fi", "<#1401#>", "<#659#>", "AiMesh"];/* untranslated */
...
selectOption = { "12 <#1772#>" : hour_to_sec(12), "1 <#1312#>" : hour_to_sec(24), "2 <#1312#>" : hour_to_sec(48), "3 <#1312#>" : hour_to_sec(72) };
}
else {
selectOption = { "6 <#1772#>" : hour_to_sec(6), "12 <#1772#>" : hour_to_sec(12), "24 <#1772#>" : hour_to_sec(24) };
}
...
if($("input[name=dblog_tousb_cb]").prop("checked")) {
if(media_support)
$(".dblog_service_item.all").after(gen_service_option(4, "<#659#>", "noUSB"));
if(!nodm_support)
$(".dblog_service_item.all").after(gen_service_option(2, "<#1401#>", "noUSB"));
}
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#303#> - <#2053#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div id="fb_desc0" class="formfontdesc" style="display:none;"><#1557#></div>
<div id="fb_desc1" class="formfontdesc" style="display:none;"><#1558#></div>
<div id="fb_desc_disconnect" class="formfontdesc" style="display:none;color:#FC0;"><#1559#> <a href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top" style="color:#FFCC00;">router_feedback@asus.com</a></div>
...
<th><#1563#> *</th>
<td>
<input type="checkbox" class="input" name="attach_syslog" id="attach_syslog_id"><label for="attach_syslog_id"><#629#></label>&nbsp;&nbsp;&nbsp;
<input type="checkbox" class="input" name="attach_cfgfile" id="attach_cfgfile_id"><label for="attach_cfgfile_id"><#1582#></label>&nbsp;&nbsp;&nbsp;
<span id="attach_iptables_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_iptables" id="attach_iptables_id"><label for="attach_iptables_id"><#1570#></label></span>
<span id="attach_modem_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_modemlog" id="attach_modemlog_id"><label for="attach_modemlog_id"><#1528#></label></span>
<input type="checkbox" class="input" name="attach_wlanlog" id="attach_wlanlog_id"><label for="attach_wlanlog_id"><#1592#></label>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(25,11);"><#1553#> *</a></th>
<td>
<input type="radio" name="dslx_diag_enable" class="input" value="1" onclick="change_dsl_diag_enable(1);"><#140#>
<input type="radio" name="dslx_diag_enable" class="input" value="0" onclick="change_dsl_diag_enable(0);" checked><#139#>
<br>
<span id="storage_ready" style="display:none;color:#FC0">* <#2781#></span>
<span id="be_lack_storage" style="display:none;color:#FC0">* <#2203#></span>
</td>
</tr>
...
<option value="0" selected><#114#></option>
<option value="3600">1 <#1772#></option>
<option value="18000">5 <#1772#></option>
<option value="43200">12 <#1772#></option>
<option value="86400">24 <#1772#></option>
</select>
</td>
</tr>
<tr class="dblog_support_class">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34, 1);"><#1554#></a></th>
<td>
<div class="dblog_disabled_status">
<input type='radio' name='dblog_enable' id='dblog_status_en' value="1" onclick="diag_change_dblog_status();"><label for='dblog_status_en'><#140#></label>
<input type='radio' name='dblog_enable' id='dblog_status_dis' value="0" onclick="diag_change_dblog_status();" checked><label for='dblog_status_dis'><#139#></label>
<label class="storeUSBHint"><input type="checkbox" name="dblog_tousb_cb" value="1" onclick="diag_change_storeUSB();" checked>Store in USB disk</label>
<span class="noUSBHint">* <#2203#></span>
</div>
<div class="dblog_enabled_status">
<span>* <#1547#></span>
<br>
<span class="dblog_stop_text" onclick="dblog_stop();"><#1546#></span>
</div>
</td>
</tr>
...
<div class="dblog_disabled_status">
<label class="dblog_service_item all"><input type="checkbox" name="dblog_service_list_all" onclick="diag_change_service_list_all();"><#1090#></label>
</div>
<div class="dblog_enabled_status">
...
<option value="Not_selected"><#607#> ...</option>
<option value="Stable_connection"><#1584#></option>
<option value="Occasional_interruptions"><#1578#></option>
<option value="Frequent_interruptions"><#1569#></option>
<option value="Unavailable"><#1589#></option>
</select>
</td>
</tr>
<tr>
...
<span style="color:#FC0"><#1572#> : </span>
...
<div id="eula_content" style="margin-left: 20px;"><#1590#></div>
</div>
<input class="button_gen" style="margin-left: 305px; margin-top:5px;" name="btn_send" onclick="applyRule()" type="button" value="<#1206#>"/>
</td>
</tr>
<tr>
<td colspan="2">
<strong><#1696#></strong>
<ul>
<li><#1577#><br><a style="font-weight: bolder;text-decoration:underline;cursor:pointer;" href="https://www.asus.com/support/CallUs/" target="_blank">https://www.asus.com/support/CallUs/</a></li>
</ul>
</td>
</tr>
</table>
