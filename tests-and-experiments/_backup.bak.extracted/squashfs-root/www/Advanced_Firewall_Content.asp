...
add_option(document.form.LWKnownApps, "<#1842#>", "User Defined", 1);
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#1853#></td>';
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#297#> - <#300#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#1600#></div>
<div class="formfontdesc"><#1602#></div>
<div class="formfontdesc" style="color:#FFCC00;"><#1603#></div>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#300#></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,5);"><#1622#></a></th>
<td>
<input type="radio" value="1" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '1')" <% nvram_match_x("FirewallConfig","fw_lw_enable_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '0')" <% nvram_match_x("FirewallConfig","fw_lw_enable_x", "0", "checked"); %>><#139#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,3);"><#1619#></a></th>
<td>
<select name="filter_lw_default_x" class="input_option">
<option value="DROP" <% nvram_match("filter_lw_default_x", "DROP","selected"); %>><#2990#></option>
<option value="ACCEPT" <% nvram_match("filter_lw_default_x", "ACCEPT","selected"); %>><#1131#></option>
</select>
</td>
</tr>
<tr>
...
<option value="User Defined"><#1842#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#1615#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Mon" class="input" onclick="check_Timefield_checkbox()"><#1306#>
<input type="checkbox" name="filter_lw_date_x_Tue" class="input" onclick="check_Timefield_checkbox()"><#1310#>
<input type="checkbox" name="filter_lw_date_x_Wed" class="input" onclick="check_Timefield_checkbox()"><#1311#>
<input type="checkbox" name="filter_lw_date_x_Thu" class="input" onclick="check_Timefield_checkbox()"><#1309#>
<input type="checkbox" name="filter_lw_date_x_Fri" class="input" onclick="check_Timefield_checkbox()"><#1305#>
</td>
</tr>
<tr id="enable_time_week_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,2);"><#1617#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#1615#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Sat" class="input" onclick="check_Timefield_checkbox()"><#1307#>
<input type="checkbox" name="filter_lw_date_x_Sun" class="input" onclick="check_Timefield_checkbox()"><#1308#>
</td>
</tr>
...
<tr>
<th ><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,4);"><#1624#></a></th>
<td>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#1627#>&nbsp;(<#2021#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#1625#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#1626#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#1620#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#1626#></a></th>
<th><#1849#></th>
<th><#2020#></th>
</tr>
