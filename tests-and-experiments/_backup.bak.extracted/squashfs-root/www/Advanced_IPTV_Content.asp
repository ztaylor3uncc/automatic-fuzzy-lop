...
document.getElementById("iptv_configure_status").innerHTML = "<#711#>";
else
document.getElementById("iptv_configure_status").innerHTML = "Unconfigured";
if(check_config_state("voip"))
document.getElementById("voip_configure_status").innerHTML = "<#711#>";
else
...
<option value="" <% nvram_match("wan_auth_x_now", "", "selected"); %>><#714#></option>
<option value="8021x-md5" <% nvram_match("wan_auth_x_now", "8021x-md5", "selected"); %>>802.1x MD5</option>
</select></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,4);"><#372#></a></th>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#282#> - IPTV</div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#1928#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#1929#></div>
<div id="IPTV_desc_DualWAN_BRTAC828" class="formfontdesc" style="display:none;">
You must select "Ethernet LAN" as the primary WAN to use IPTV function. Please go to <a href="/Advanced_WANPort_Content.asp" style="text-decoration: underline;">WAN - Dual WAN</a> to confirm that Ethernet LAN port is assigned to primary WAN.</div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<thead>
<tr>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#606#></a></th>
<td>
<select name="switch_wantag" class="input_option" onChange="ISP_Profile_Selection(this.value)">
<option value="none" <% nvram_match( "switch_wantag", "none", "selected"); %>><#714#></option>
...
<option id="manualOption" value="manual" <% nvram_match( "switch_wantag", "manual", "selected"); %>><#268#></option>
</select>
</td>
</tr>
<tr id="wan_stb_x">
...
<option value="0" <% nvram_match( "switch_stb_x", "0", "selected"); %>><#714#></option>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#3075#></option>
...
<!--tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#2394#></a></th>
<td>
<input type="radio" value="1" name="mr_enable_x" class="input" onClick="disable_udpxy();" <% nvram_match("mr_enable_x", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="mr_enable_x" class="input" onClick="disable_udpxy();" <% nvram_match("mr_enable_x", "0", "checked"); %>><#139#>
</td>
</tr-->
<tr id="mr_enable_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#2394#> (IGMP Proxy)</a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#3075#></option>
<option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#3074#></option>
</select>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#3075#></span>
<span style="margin-left: 5px;">(Due to hardware limitation, IGMP proxy cant co-exist with IPTV function.)</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#3075#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#3074#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#2404#></a></th>
<td>
