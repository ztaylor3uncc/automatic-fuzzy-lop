...
<title><#709#> - Subnet Management</title>
...
alertMsg("<#3248#>", ipConflict_cp.ipAddr, ipConflict_cp.netLegalRangeStart, ipConflict_cp.netLegalRangeEnd);
return false;
}
}
if(cp_freewifi_support){
...
<tr>
<td align="left">
<span class="formfonttitle"><#646#></span>
...
<th><#1922#></th>
<td>
<input type="radio" value="1" name="radioDHCPEnable" class="content_input_fd" checked><#140#>
<input type="radio" value="0" name="radioDHCPEnable" class="content_input_fd"><#139#>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="dhcp_static" /><#140#>
<input type="radio" value="0" name="dhcp_static" /><#139#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1939#>&nbsp;(<#2021#>&nbsp;<span id="max_staticIp_num" style="color:#FFF;">8</span>)</td>
</tr>
</thead>
<tr>
...
<input class="button_gen" type="button" onclick="show_subnet_edit(0);" value="<#150#>">
<input id="saveButton" class="button_gen" type="button" onclick="" value="<#1287#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#282#> - <#2540#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#316#></div>
<div style="margin-left:8px; margin-bottom:7px;"> <div style="font-size:12px; font-weight:800;display:table-cell;vertical-align:bottom;"><#317#>&nbsp;(<#2021#>&nbsp;8)</div><div style="display:table-cell;padding-left:6px;"><input id="add_subnet_btn" type="button" class="add_btn" onClick="add_subnet();" value=""></div></div>
...
<tr>
<th style="width:19%"><#2399#></th>
<th style="width:19%"><#215#></th>
<th style="width:19%"><#1945#></th>
<th style="width:19%"><#1943#></th>
<th style="width:10%"><#1935#></th>
<th style="width:7%"><#2347#></th>
<th><#1272#></th>
</tr>
</table>
