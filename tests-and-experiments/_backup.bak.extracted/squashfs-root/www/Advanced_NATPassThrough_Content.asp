...
<title><#709#> - NAT Pass-Through</title>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#286#> - <#319#></div>
...
<option class="content_input_fd" value="0" <% nvram_match("fw_pt_pptp", "0","selected"); %>><#1200#></option>
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_pptp", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="0" <% nvram_match("fw_pt_l2tp", "0","selected"); %>><#1200#></option>
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_l2tp", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="0" <% nvram_match("fw_pt_ipsec", "0","selected"); %>><#1200#></option>
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_ipsec", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="0" <% nvram_match("fw_pt_rtsp", "0","selected"); %>><#1200#></option>
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_rtsp", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="0" <% nvram_match("fw_pt_h323", "0","selected"); %>><#1200#></option>
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_h323", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="0" <% nvram_match("fw_pt_sip", "0","selected"); %>><#1200#></option>
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_sip", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,11);"><#2312#></a></th>
<td>
<select name="fw_pt_pppoerelay" class="input_option" onChange="update_pppoerelay_option();">
<option class="content_input_fd" value="0" <% nvram_match("fw_pt_pppoerelay", "0","selected"); %>><#1200#></option>
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_pppoerelay", "1","selected"); %>><#3074#></option>
</select>
</td>
<th id="pppoerelay_unit_th"><#2949#></th>
<td id="pppoerelay_unit_td">
<select name="pppoerelay_unit" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("pppoerelay_unit", "0","selected"); %>><#1472#></option>
<option class="content_input_fd" value="1"<% nvram_match("pppoerelay_unit", "1","selected"); %>><#1478#></option>
</select>
</td>
</tr>
<tr>
