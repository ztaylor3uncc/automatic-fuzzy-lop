...
document.getElementById("wl_unit_field_1_1").innerHTML = '5 GHz-1 - <#604#>';
document.getElementById("syncCheckbox").innerHTML = "<#520#>";
document.getElementById("syncCheckbox_5_2").innerHTML = "<#521#>";
...
/*if(findasus_support){
$("#mode_desc").html("<#326#><br/><span style=\"color:#FC0\"><#328#></span>");
}else{*/
var desc = "";
if(amesh_support) {
desc += "<#327#>";
...
desc += "<#46#>";
desc += "<br>";
desc += "<span style=\"color:#FC0\"><#1345#></span>";
}
else
desc = "<#326#><br/><span style=\"color:#FC0\"><#1344#></span>";
$("#mode_desc").html(desc);
clearTimeout(id_WANunplungHint);
$("#Unplug-hint").css("display", "none");
...
pstaDesc += "<#342#>";
pstaDesc += "<br><#343#>";
pstaDesc += "<br/><span style=\"color:#FC0\"><#1346#></span>";
if(odmpid == "RT-AC66U_B1" || odmpid == "RT-AC1750_B1" || odmpid == "RT-N66U_C1" || odmpid == "RT-AC1900U")
...
document.getElementById("wl_unit_field_5").style.display = "";
document.getElementById("wl_unit_field_6").style.display = "";
document.getElementById("wl0_desc_name").innerHTML = "2.4 GHz - <#604#>";
...
<input type="radio" value="1" id="smart_connect_t" name="smart_connect_t" class="input" onclick="return change_smart_con(this.value)" <% nvram_match("smart_connect_x", "1", "checked"); %>><#657#>
</td>
</tr>
<tr>
<td style="font-style:normal;font-size:13px;font-weight:bold;">
...
<tr>
<div class="description_down"><#597#></div>
</tr>
<tr>
<div class="QISGeneralFont" align="left"><#555#></div>
</tr>
<tr>
...
<tr>
<th width="180" id="wl0_desc_name">2.4GHz - <#604#></th>
<td class="QISformtd"></td>
</tr>
<tr>
<th width="180">
<span onmouseout="return nd();" onclick="openHint(0, 22);" style="cursor:help;"><#452#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span>
</th>
<td class="QISformtd">
...
<th width="180">
<span onmouseout="return nd();" onclick="openHint(0, 23);" style="cursor:help;"><#320#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span>
</th>
<td class="QISformtd">
...
<th id="wl_unit_field_1_1" width="180">5GHz - <#604#> </th>
<td class="QISformtd">
<input type="checkbox" id="sync_with_2ghz" name="sync_with_2ghz" class="input" onclick="setTimeout('Sync_2ghz(2);',0);" checked="checked"><span id="syncCheckbox"><#519#></span>
</td>
</tr>
...
<th width="180">5 GHz-2 - <#604#> </th>
<td class="QISformtd" id="wl_unit_field_4_2">
<input type="checkbox" id="sync_with_5ghz" name="sync_with_5ghz" tabindex="8" class="input" onclick="setTimeout('Sync_5ghz(2);',0);" checked="checked"><span id="syncCheckbox_5_2"><#519#></span>
</td>
</tr>
<tr id="wl_unit_field_5" style="display:none;">
<th width="180"><span onmouseout="return nd();" onclick="openHint(0, 22);" style="cursor:help;"><#452#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span></th>
<td class="QISformtd">
...
<th width="180"><span onmouseout="return nd();" onclick="openHint(0, 23);" style="cursor:help;"><#320#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span></th>
<td class="QISformtd">
...
<tr>
<td colspan="2">
<div class="QISGeneralFont" ><#556#></div>
</td>
</tr>
</table>
<div style="margin-top:20px;text-align:center;background-color:#2B373B">
<input type="button" value="<#150#>" class="button_gen" onclick="cancel_SSID_Block();">
<input type="button" id="btn_next_step" value="<#148#>" class="button_gen" onclick="applyRule();">
</div>
</div>
...
<td>
<div>&nbsp;</div>
<div class="formfonttitle"><#303#> - <#305#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#332#></div>
</td>
</tr>
...
<td>
<div id="Senario" >
<div id="Unplug-hint" style="border:2px solid red; background-color:#FFF; padding:3px;margin:0px 0px 0px 150px;width:250px; position:absolute; display:block; display:none;"><#696#></div>
</div>
<div class="apply_gen">
<input name="button" type="button" class="button_gen" onClick="saveMode();" value="<#1288#>">
</div>
</td>
</tr>
</table>
