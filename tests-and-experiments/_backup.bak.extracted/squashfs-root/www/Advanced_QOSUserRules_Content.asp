...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2058#> - <#1521#>";
}
else{
document.getElementById('content_title').innerHTML = "<#271#> - QoS";
}
showqos_rulelist();
load_QoS_rule();
...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#607#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#232#>");
return false;
}
}
}
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2040#>");
return false;
}
}
replace_symbol();
...
alert("<#2808#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#1770#></option>';
else
code += '<option value="0"><#1770#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#1769#></option>';
else
code += '<option value="1"><#1769#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2051#></option>';
else
code += '<option value="2"><#2051#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2029#></option>';
else
code += '<option value="3"><#2029#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2030#></option>';
else
code += '<option value="4"><#2030#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#2356#></option>
<option value="3"><#2355#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1191#>&nbsp;(<#2021#>&nbsp;32)</td>
...
<tr>
<th><#1192#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1193#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1194#></div></a></th>
<th><div class="table_text"><#1849#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#2795#></div></a></th>
<th><#1195#></th>
<th><#2020#></th>
</tr>
<tr>
<td width="20%">
<input type="text" maxlength="32" class="input_12_table" style="float:left;width:105px;" placeholder="<#607#>" name="qos_service_name_x_0" onKeyPress="return validator.isString(this, event)" autocorrect="off" autocapitalize="off">
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullQoSList(this);" title="<#2435#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2430#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#1770#></option>
<option value='1' selected><#1769#></option>
