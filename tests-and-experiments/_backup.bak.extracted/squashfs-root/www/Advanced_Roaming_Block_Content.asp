...
wlHintHtml += '<div class="prod_madelName"><div class="title_name"><div class="div_td img_gap"><div class="login_img"></div></div><div class="div_td"><#710#></div></div></div>';
wlHintHtml += '<div id="login_filed">';
wlHintHtml += "<div class='p1 title_gap'><#168#></div>";
for(var i=0; i<wlObj.length; i++){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#275#> - <#2996#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2375#></div>
...
<th width="30%"><#2376#></th>
<td>
<label><input type="radio" name="enable_roaming" value="1" onclick="enable_roaming_block();" <% nvram_match("rast_static_cli_enable", "1","checked"); %>><#140#></label>
<label><input type="radio" name="enable_roaming" value="0" onclick="enable_roaming_block();" <% nvram_match("rast_static_cli_enable", "0","checked"); %>><#139#></label>
</td>
</tr>
</table>
