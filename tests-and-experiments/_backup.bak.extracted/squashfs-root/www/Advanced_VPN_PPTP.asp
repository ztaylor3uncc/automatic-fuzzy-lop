...
document.getElementById("dualwan_ctrl").innerHTML = "<#2320#> <span class=\"formfontdesc\">Primary WAN IP : " + wan0_ipaddr + " </sapn><span class=\"formfontdesc\">Secondary WAN IP : " + wan1_ipaddr + "</sapn>";
...
document.getElementById("wan_ctrl").innerHTML = "<#2320#>" + wan_ipaddr;
...
$rowObj.children(":first").html('<a class="hintstyle2" href="javascript:void(0);" onClick="showPPTPClients(\''+pptpd_connected_clients[y].username+'\');"><#142#></a>');
}
break;
}
}
...
$rowObj.children(":first").html("<#1853#>");
else
$rowObj.children(":first").html("<#167#>");
}
}
else {
if($rowObj.children().length == 1)
...
alert(document.form._pptpd_clients_start.value + " <#232#>");
document.form._pptpd_clients_start.focus();
document.form._pptpd_clients_start.select();
return false;
}
...
code +='<tr><td style="color:#FFCC00;" colspan="5"><#1853#></td></tr>';
else{
...
alert("<#2808#> " + document.form._pptpd_clients_start.value);
document.form._pptpd_clients_end.focus();
document.form._pptpd_clients_end.select();
setEnd();
return false;
...
document.getElementById("pptpd_conflict").innerHTML = "<#2820#> <b>"+origin_lan_ip+"</b>";
return;
}
...
document.getElementById("pptpd_conflict").innerHTML = "<#2818#> <b>"+pool_start+" ~ "+pool_end+"</b>";
return;
}
if(dhcp_staticlists != ""){
...
document.getElementById("pptpd_conflict").innerHTML = "<#2819#> <b>"+static_ip+"</b>";
return;
}
}
}
...
<div>&nbsp;</div>
<div id="divVPNTitle" class="formfonttitle"><#129#> - PPTP</div>
<div id="divSwitchMenu" style="margin-top:-40px;float:right;"></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div id="privateIP_notes" class="formfontdesc" style="display:none;color:#FC0;"><#2883#></div>
...
<th><#2831#></th>
<td>
<input type="radio" value="1" name="pptpd_ms_network_option" onClick="set_pptpd_broadcast(this);"/><#140#>
<input type="radio" value="0" name="pptpd_ms_network_option" onClick="set_pptpd_broadcast(this);"/><#139#>
</td>
</tr>
</table>
<div id="PPTP_setting" style="display:none;margin-top:8px;">
<div class="formfontdesc"><#2319#></div>
<div id="wan_ctrl" class="formfontdesc"></div>
<div id="dualwan_ctrl" style="display:none;" class="formfontdesc"></div>
<div class="formfontdesc" style="margin-top:-10px;"><#2321#></div>
<div class="formfontdesc" style="margin-top:-10px;">(7) <#2213#></div>
<div class="formfontdesc" style="margin:-10px 0px 0px -15px;">
<ul>
<li>
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#129#> FAQ</a>
</li>
</ul>
</div>
...
<th><#2812#></th>
<td>
<input type="radio" value="1" name="pptpd_broadcast_option" onClick="setBroadcast(this);"/><#140#>
<input type="radio" value="0" name="pptpd_broadcast_option" onClick="setBroadcast(this);"/><#139#>
<span id="pptpd_broadcast_hint" style="font-family: Lucida Console;color: #FFCC00;display: none;"><#2318#></span>
</td>
</tr>
<tr>
<th><#2291#></th>
...
<option value="0" <% nvram_match("pptpd_chap", "0","selected"); %>><#114#></option>
...
<input type="checkbox" class="input" name="pptpd_mppe_no" onClick="return changeMppe();"><#2201#>
</td>
</tr>
<tr>
<th><#211#></th>
<td>
<input type="radio" name="pptpd_dnsenable_x" class="input" value="1" onclick="return change_pptpd_radio(this)" /><#140#>
<input type="radio" name="pptpd_dnsenable_x" class="input" value="0" onclick="return change_pptpd_radio(this)" /><#139#>
</td>
</tr>
<tr>
<th><#207#></th>
...
<th><#1869#></th>
<td>
<input type="radio" name="pptpd_winsenable_x" class="input" value="1" onclick="return change_pptpd_radio(this)" /><#140#>
<input type="radio" name="pptpd_winsenable_x" class="input" value="0" onclick="return change_pptpd_radio(this)" /><#139#>
</td>
</tr>
<tr>
<th><#1867#></th>
...
<span id="pptpd_subnet" style="font-family: Lucida Console;color: #FFF;"></span><input type="text" maxlength="3" class="input_3_table" name="_pptpd_clients_end" value="" autocorrect="off" autocapitalize="off"/><span style="color:#FFCC00;"> <#2829#></span>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,1);"><#2400#></a></th>
<td>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,2);"><#2401#></a></th>
<td>
...
<input class="button_gen" type="button" onclick="srCancel();" value="<#150#>">
<input class="button_gen" type="button" onclick="srConfirm();" value="<#1287#>">
</div>
</div>
</form>
<div id="footer"></div>
