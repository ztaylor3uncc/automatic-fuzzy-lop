...
add_option(document.form.KnownGames, "<#607#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#1853#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#1855#>&nbsp;(<#2021#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1192#></th>';
html += '<th width="15%"><#1856#></th>';
html += '<th width="15%"><#1857#></th>';
html += '<th width="17%"><#1858#></th>';
html += '<th width="8%"><#1849#></th>';
html += '<th width="17%"><#1854#></th>';
html += '<th width="6%"><#2347#></th>';
html += '<th width="6%"><#1272#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1472#></option>")
.append("<option value='1'><#1478#></option>")
...
<div>&nbsp;</div>
<div class="formfonttitle"><#286#> - <#289#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div>
<div class="formfontdesc"><#1846#></div>
<ul style="margin-left:-25px; *margin-left:10px;">
<div class="formfontdesc"><li><#1634#></div>
<div class="formfontdesc" id="FTP_desc"><li><#1609#></div>
</ul>
</div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#289#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2010#></div>
...
<tr>
<th><#1845#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#2939#>">
</div>
</td>
</tr>
</tbody>
...
<option value="0"><#1472#></option>
<option value="1"><#1478#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#1857#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#1858#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#2432#>">
...
<input class="button_gen" type="button" onclick="cancelProfile();" value="<#150#>">
<input id="saveProfile" class="button_gen" type="button" value="<#1287#>">
</div>
</div>
<div id="footer"></div>
</form>
