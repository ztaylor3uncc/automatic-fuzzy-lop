...
var confirm_str = "Configure "+ conflict_lanport_text +" as WAN will disable \""+"<#2159#>"+"\" function, are you sure to do it?";//untranslated
...
consume_warning_str = "<#165#> "+consume_bytes+" <#166#>";
...
<tr><td colspan="2"><#2517#></td></tr><tr><td colspan="2"><#2518#>&nbsp;:&nbsp;<span id="str_detect_time"></span>&nbsp;<#2425#>.</td></tr>
<tr>
<th style="width:30%;"><#2523#></th>
<td>
<input type="text" name="detect_interval" class="input_3_table" maxlength="1" value=""; placeholder="5" autocorrect="off" autocapitalize="off" onKeyPress="return validator.isNumber(this, event);" onblur="update_str_time();" style="width: 38px; margin: 0px;">&nbsp;&nbsp;<#2425#>
</td>
</tr>
<tr>
<th><#2525#></th>
...
<span id="detect_tail_msg">&nbsp;( Detection Time: <span id="detection_time_value"></span>&nbsp;&nbsp;<#2425#>)</span>
</td>
</tr>
</table>
<div style="padding-bottom:10px;width:100%;text-align:center;">
<input id="yesButton" class="button_gen" type="button" value="<#140#>" onclick="change_detect_settings();">
<input id="noButton" class="button_gen" type="button" value="<#139#>" onclick="remain_origins();">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#286#> - <#171#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#1440#><a id="dualwan_faq" href="" target="_blank" style="margin-left:5px; text-decoration: underline;"><#171#> FAQ</a></div>
...
<option value="fo"><#1455#></option>
<option value="lb" <% nvram_match("wans_mode", "lb", "selected"); %>><#1456#></option>
</select>
<span id="wans_mode_fo" style="margin-left:5px; color:#FFF; display:none;"><#1455#></span>
<span id="fb_span" style="display:none"><input type="checkbox" id="fb_checkbox"><#1442#></span>
<script>
...
<div id="lb_note" style="color:#FFCC00; display:none;"><#1452#></div>
<div id="lb_note2" style="color:#FFCC00; display:none;"><#1453#></div>
</td>
</tr>
...
<option value="1" <% nvram_match("wans_standby", "1", "selected"); %>><#3074#></option>
<option value="0" <% nvram_match("wans_standby", "0", "selected"); %>><#3075#></option>
</select>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1472#>
<input type="radio" value="2" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1478#>
</td>
</tr>
<tr class="ISPProfile">
<th><#1448#></th>
...
<thead>
<tr>
<td colspan="2"><#1471#><div style="font-weight: normal; font-style: italic; margin-top: 5px;"><#1526#></div></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,3);"><#2524#></a></th>
<td id="retry_intervale_setting"><#175#>
<div><span id="consume_bytes_warning" style=""></span></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,5);"><div id="fo_detection_count_hd"><#1447#></div></a></th>
<td id="wandog_maxfail_setting"><#1446#></td>
</tr>
<tr id="wandog_fb_count_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,6);"><div id="fb_detection_count_hd"><#1445#></div></a></th>
<td id="wandog_fbcount_setting"><#1444#></td>
</tr>
<tr>
<th><#2177#></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2434#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<th><#1476#></th>
<td>
<input type="radio" value="1" name="wans_routing_enable" onClick="enable_lb_rules(this.value)" class="content_input_fd" <% nvram_match("wans_routing_enable", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="wans_routing_enable" onClick="enable_lb_rules(this.value)" class="content_input_fd" <% nvram_match("wans_routing_enable", "0", "checked"); %>><#139#>
</td>
</tr>
</table>
