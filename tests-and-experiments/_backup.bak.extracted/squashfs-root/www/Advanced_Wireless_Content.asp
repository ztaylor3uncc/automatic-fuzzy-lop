...
document.getElementById("auto_channel").innerHTML = "<#3005#>: " + temp;
}
}
}
...
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3181#>';
else{
if(band5g_11ac_support)
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3184#>';
else
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3185#>';
}
...
if(flag == 1 || flag == 2){
if(based_modelid == "RT-AC87U"){
obj.options[0] = new Option("<#114#>", 0);
...
var tmo2nmode = [["0", "<#114#>"],["6", "B Only"],["5", "G Only"],["1", "N Only"],["2", "B/G Mixed"],["4", "G/N Mixed"]];
var tmo5nmode = [["0", "<#114#>"],["7", "A Only"],["1", "N Only"],["3", "AC Only"],["4", "A/N Mixed"]];
...
free_options(document.form.wl_nmode_x);
document.form.wl_nmode_x.options[0] = new Option("<#114#>", 0);
...
<div>&nbsp;</div>
<div class="formfonttitle"><#275#> - <#276#></div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc"><#784#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0,27);"><#2493#></a></th>
<td>
...
<div id="radio_smartcon_enable" class="left" style="width: 94px;display:table-cell;"></div><div id="smartcon_rule_link" style="display:table-cell; vertical-align: middle;"><a href="Advanced_Smart_Connect.asp" style="font-family:Lucida Console;color:#FC0;text-decoration:underline;cursor:pointer;"><#2496#></a></div>
<div class="clear"></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_bss_enabled", "0","selected"); %>><#3075#></option>
<option class="content_input_fd" value="1" <% nvram_match("wl_bss_enabled", "1","selected"); %>><#3074#></option>
</select>
</td>
</tr-->
<tr>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#3096#></a></th>
<td>
<input type="radio" value="1" name="wl_closed" class="input" <% nvram_match("wl_closed", "1", "checked"); %>><#140#>
<input type="radio" value="0" name="wl_closed" class="input" <% nvram_match("wl_closed", "0", "checked"); %>><#139#>
</td>
</tr>
<tr>
<th><a id="wl_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#3134#></a></th>
<td>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#3136#></input></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#3135#></input></span>
<span id="wl_nmode_x_hint" style="display:none;"><br><#3182#><br></span>
...
<span id="enable_160_field" style="display:none"><input type="checkbox" onClick="enable_160MHz(this);" id="enable_160mhz" ><#3025#></span>
</td>
</tr>
<tr>
<th>
<a id="wl_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#715#></a>
</th>
<td>
...
<span id="dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#3046#></input></span>
<span id="acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#3044#></input></span>
<span id="acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#3045#></input></span>
<span id="acs_ch13_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#3043#></input></span>
</td>
</tr>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#3145#></a></th>
<td>
...
<option value="0" <% nvram_match("wl_mfp", "0", "selected"); %>><#3075#></option>
<option value="1" <% nvram_match("wl_mfp", "1", "selected"); %>><#3127#></option>
<option value="2" <% nvram_match("wl_mfp", "2", "selected"); %>><#3128#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#3156#></a></th>
...
<div class="apply_gen">
<input type="button" id="applyButton" class="button_gen" value="<#148#>" onclick="applyRule();">
</div>
</td>
</tr>
</tbody>
