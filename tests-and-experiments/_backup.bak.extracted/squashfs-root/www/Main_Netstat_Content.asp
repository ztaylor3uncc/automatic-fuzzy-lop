...
<script>
option_netstat = new Array("<#2480#>","<#2484#>","<#2485#>","<#2483#>","<#2486#>","<#2481#>","<#1384#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2167#>", "<#2168#>", "<#2169#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2187#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2180#> - Netstat</div>
<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
<div class="formfontdesc" id="cmdDesc"><#2187#></div>
...
<option value="-a"><#2480#></option>
<option value="-ta"><#2484#></option>
<option value="-ua"><#2485#></option>
<option value="-w"><#2483#></option>
<option value="-xa"><#2486#></option>
<option value="-l"><#2481#></option>
<option value="-r"><#1384#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2194#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2431#>">
...
<option value="-r state" selected><#2174#></option>
<option value="-r src"><#2172#></option>
<option value="-r dst"><#2170#></option>
<option value="-r src-port"><#2173#></option>
<option value="-r dst-port"><#2171#></option>
</select>
</td>
</tr>
