...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#2534#></td>
</tr>
<tr>
<td>
<div style="margin-left:20px;">
<p><input type="radio" name="check_asus_ddns" id="c1" onClick="switch_ddns();" checked>
<label for="c1"><#1326#></label>
</p>
<br/>
...
<input type="button" id="prevButton" value="<#156#>" onclick="go_pre_page();" class="button_gen">
<input type="button" id="nextButton" value="<#155#>" onclick="apply_eula_check();"class="button_gen">
