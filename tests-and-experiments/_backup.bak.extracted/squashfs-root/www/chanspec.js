...
extend_channel = ["<#114#>"]; // for 5GHz, extension channel always displays Auto
...
if (chanspecs[i] == 0)
document.form.wl_channel[i] = new Option("<#114#>", chanspecs[i]);
else
