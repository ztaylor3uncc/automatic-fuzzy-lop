...
code += '<span title="Change to default client icon" onclick="card_setDefaultIcon();"><#1274#></span>';
code += '<span id="card_changeIconTitle" title="Change client icon" style="margin-left:10px;" onclick="card_show_custom_image();"><#1268#></span>';
code += '</div>';
}
code += '</td>';
...
code += '<input class="button_gen" type="button" style="margin-right:5px;" onclick="card_closeClientListView();" value="<#150#>">';
code += '<input id="card_client_confirm" class="button_gen" type="button" onclick="card_confirm(\''+callBack+'\');" value="<#148#>">';
...
connectModeTip += "<#740#>: " + clientInfo.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
document.getElementById("card_changeIconTitle").innerHTML = "<#1271#>";
}
else {
slideFlag = true;
slideUp("card_custom_image", 500);
document.getElementById("card_changeIconTitle").innerHTML = "<#1268#>";
}
}
}
...
code += '<thead><tr>';
code += '<td colspan="4">Client upload icon&nbsp;(<#2021#>&nbsp;100)</td>'; /*untranslated*/
code += '</tr></thead>';
code += '<tr>';
code += '<th width="45%"><#2242#></th>';
code += '<th width="30%"><#2240#></th>';
code += '<th width="15%"><#1213#></th>';
code += '<th width="10%"><#1272#></th>';
code += '</tr>';
code += '</table>';
code += '<div id="card_usericons_block"></div>';
code += '<div style="margin-top:15px;padding-bottom:10px;width:100%;text-align:center;">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_cancel();" value="<#150#>">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_confirm();" value="<#1287#>">';
...
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#1090#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter clientlist_ByInterface' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#2949#></div>";
drawSwitchModeHtml += "</div>";
}
else {
drawSwitchModeHtml += "<div class='block_filter clientlist_All' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#1090#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter_pressed clientlist_ByInterface'>";
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#2949#></div>";
drawSwitchModeHtml += "</div>";
}
drawSwitchModeHtml += "</div>";
...
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#1818#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1213#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"all_list\");' style='cursor:pointer;'><#2242#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"all_list\");' style='cursor:pointer;'><#2816#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"all_list\");' style='cursor:pointer;'><#2240#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"all_list\");' style='cursor:pointer;'><#2949#></th>";
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"str\", \"all_list\");' style='cursor:pointer;'><#740#></th>";
}
code += "</tr>";
code += "</table>";
...
case "ByInterface" :
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='" + wl_colspan + "'><#2610#>";
...
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#1818#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1213#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wired_list\");' style='cursor:pointer;'><#2242#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wired_list\");' style='cursor:pointer;'><#2816#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wired_list\");' style='cursor:pointer;'><#2240#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " ><#2949#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + "><#740#></th>";
}
code += "</tr>";
code += "</table>";
...
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#1818#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1213#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2242#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2816#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2240#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2949#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#740#></th>";
}
code += "</tr>";
code += "</table>";
...
if(!top.isIE8)
code += "<div style='text-align:center;margin-top:15px;'><input type='button' class='button_gen' onclick='exportClientListLog();' value='<#1203#>'></div>";
code += "</td></tr></tbody>";
code += "</table>";
divObj.innerHTML = code;
...
clientListCode += "<tr id='tr_" + objID + "'><td style='color:#FFCC00;' colspan='" + wl_colspan + "'><#1853#></td></tr>";
}
else {
...
document.getElementById(_obj).innerText = "<#2214#>";
}
else {
slideFlag = true;
slideUp(_controlObj, 100);
document.getElementById(_obj).innerText = "<#2215#>";
}
}
}
...
htmlCode += "<div id='" + _containerID + "_clientlist_dropdown_expand' class='clientlist_dropdown_expand' onclick='expand_hide_Client(\"" + _containerID + "_clientlist_dropdown_expand\", \"" + _containerID + "_clientlist_offline\");' onmouseover='over_var=1;' onmouseout='over_var=0;'><#2215#></div>";
...
if(document.getElementById("" + _containerID + "_clientlist_dropdown_expand").innerText == "<#2215#>") {
