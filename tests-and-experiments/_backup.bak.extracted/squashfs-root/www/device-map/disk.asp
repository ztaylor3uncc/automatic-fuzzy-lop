...
<p class="formfonttitle_nwm"><#2142#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1118#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#2613#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#659#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#1204#>" >
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#853#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#1204#>" >
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
...
<input type="button" class="button_gen" onclick="gotoDM();" value="<#1204#>" >
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#2419#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#1205#>">
<div id="show_removed_string" style="display:none;"><#2417#></div>
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
</table>
...
<li><#1381#><a href="/" target="_parent"><#1382#></a><#1383#></li>
</ul>
</div>
