...
<div class="formfonttitle_nwm"><#1357#> :</div>
<div>
...
<img style="margin-top:5px;margin-left:9px; *margin-top:-10px; width:283px;" src="/images/New_ui/networkmap/linetwo2.png">
<div style="padding:7px;">
<div class="formfonttitle_nwm"><#1680#> :</div>
<div>
...
<img style="margin-top:5px;margin-left:9px; *margin-top:-10px; width:283px;" src="/images/New_ui/networkmap/linetwo2.png">
<div class="formfonttitle_nwm" style="margin-left:10px;margin-bottom:5px;margin-top:10px;"><#1679#></div>
<span id="log_field" >
...
<input id="btn_format" type="button" class="button_gen" onclick="go_format();" value="<#1281#>">
