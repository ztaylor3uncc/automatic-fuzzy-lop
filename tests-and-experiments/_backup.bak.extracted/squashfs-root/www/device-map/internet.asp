...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1312#> ";
if (Hours != 0)
value += Hours.toString() + " <#1772#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2064#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#2425#>";
return value;
}
function initial(){
flash_button();
...
showtext(document.getElementById("dualwan_mode"), "<#1456#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1455#>");
...
if(lanproto == "static")
showtext(document.getElementById("LanProto"), "<#127#>");
else
showtext(document.getElementById("LanProto"), "<#126#>");
...
wanlink_type_conv = "<#126#>";
else if(wanlink_type_conv == "static")
wanlink_type_conv = "<#127#>";
...
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#287#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#1441#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2960#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1457#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#145#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2951#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#215#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3204#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2399#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1935#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2013#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#172#></p>
<input type="button" class="button_gen_long" onclick="goToDualWAN();" value="<#1204#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
<tr id="goSetting" style="display:none">
<td height="30" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1207#></p>
<input type="button" class="button_gen_long" onclick="goToWAN();" value="<#1204#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
<!--tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:98px; "><#381#></p>
<input type="button" class="button_gen" value="<#1204#>" onclick="javascript:goQIS();">
</td>
</tr-->
</table>
...
<p class="formfonttitle_nwm"><#624#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1919#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#213#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1779#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;"><#66#></p>
<br />
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#492#>" style="float:right;">
<!--input type="button" class="button_gen" onclick="manualSetup();" value="<#268#>" style="float:right;"-->
