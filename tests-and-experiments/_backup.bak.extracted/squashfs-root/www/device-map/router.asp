...
document.getElementById("span0").innerHTML = "<#2611#>";
document.getElementById("t0").className = "tabclick_NW";
inputCtrl(document.form.wl_auth_mode_x, 0);
document.getElementById("wl_wpa_psk_title").innerHTML = "<#320#>";
...
document.form.wl_wpa_psk.value = "<#3009#>";
*/
limit_auth_method();
...
var modedesc = visible ? get_yadns_modedesc(i) + ": <#1686#> " + yadns_clients[i] : "";
...
<span id="span_status" style="cursor:pointer;font-weight: bolder;"><#613#></span>
</div>
</td>
</table>
</td>
...
<p class="formfonttitle_nwm" ><#452#></p>
...
<tr>
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#3019#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#3072#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#716#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#720#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p id="wl_wpa_psk_title" class="formfonttitle_nwm" ><#3192#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" style="float:left;"><#3010#></p>
...
<tr id="apply_tr">
<td id="bottom_border">
<input id="applySecurity" type="button" class="button_gen" value="<#148#>" onclick="submitForm();" style="margin-left:90px;">
</td>
</tr>
...
<tr id="pincode">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#2255#></p>
...
<tr>
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >LAN <#261#></p>
...
<tr id="macaddr_wl2">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl2_title">2.4GHz </span><#261#></p>
...
<tr id="macaddr_wl5">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl5_title">5GHz </span><#261#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl5_2_title">5GHz-2 </span><#261#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl60_title">60GHz </span><#261#></p>
