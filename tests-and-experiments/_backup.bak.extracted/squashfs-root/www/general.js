...
x.options[0].text = "<#3049#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#3049#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#3050#>", "upper");
...
x.options[0].text = "<#3050#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#3049#>", "lower");
...
document.getElementById("check_port_input").innerHTML="<#119#> 1 <#120#> 65535";
...
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac_input").innerHTML="<#248#>";
