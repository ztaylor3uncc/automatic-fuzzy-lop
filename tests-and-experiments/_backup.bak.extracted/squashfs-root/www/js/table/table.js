...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2021#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#1911#> " + _createRuleCount + " <#1912#>");
return;
}
...
$actionButtonCancelHtml.html("<#150#>");
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#2215#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#1905#>");
return false;
}
}
