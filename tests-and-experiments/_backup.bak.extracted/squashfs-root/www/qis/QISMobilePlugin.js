...
htmlCode += '<div class="description_down"><#450#></div></td><td align="right"></td></tr></table></div>';
...
if(sw_mode_submit == "4"){
htmlCode += "<br><br><br><p style='font-size:20px;line-height: 25px;color:#FC0;' class='QISGeneralFont'>* <#344#> <#343#>";
htmlCode += "<br><br>* <#345#>";
htmlCode += "<br><br>* <#346#>";
}else{
htmlCode += "<br><br><br><p style='font-size:20px;line-height: 25px;color:#FC0;' class='QISGeneralFont'>* <#575#>";
htmlCode += "<br><br>* <#168#>";
}
if(sw_mode_submit == "2")
htmlCode += "<br><br>* <#346#></p>";
else
htmlCode += "</p>";
