...
tab: [
{url: "Guest_network.asp", tabName: "<#198#>"},
{url: "Captive_Portal.asp", tabName: "Free Wi-Fi"},
{url: "Captive_Portal_Advanced.asp", tabName: "<#3248#>"},
...
index: "menu_QoS",
tab: [
{url: "QoS_EZQoS.asp", tabName: "<#2058#>"},
{url: "Main_TrafficMonitor_realtime.asp", tabName: "<#655#>"},
...
{url: "Main_Spectrum_Content.asp", tabName: "<#2512#>"},
...
tab: [
{url: "ParentalControl.asp", tabName: "<#359#>"},
{url: "YandexDNS.asp", tabName: "<#3204#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
tab: [
{url: "GameBoost.asp", tabName: "<#1702#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "mediaserver.asp", tabName: "<#659#>"},
{url: "Advanced_AiDisk_samba.asp", tabName: "<#293#>".concat(WebDav_support?" / <#1227#>":"")},
{url: "Advanced_AiDisk_ftp.asp", tabName: "<#294#>"},
...
{url: "cloud_sync.asp", tabName: "<#2503#>"},
{url: "cloud_router_sync.asp", tabName: "<#2442#>"},
{url: "cloud_settings.asp", tabName: "<#2462#>"},
{url: "cloud_syslog.asp", tabName: "<#2024#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
/* ============================================================================================================ */
...
index: "menu_Wireless",
tab: [
{url: "Advanced_Wireless_Content.asp", tabName: "<#276#>"},
{url: "Advanced_WWPS_Content.asp", tabName: "<#277#>"},
{url: "Advanced_WMode_Content.asp", tabName: "WDS"},
{url: "Advanced_ACL_Content.asp", tabName: "<#279#>"},
{url: "Advanced_WSecurity_Content.asp", tabName: "<#280#>"},
{url: "Advanced_WAdvanced_Content.asp", tabName: "<#281#>"},
{url: "Advanced_WProxy_Content.asp", tabName: "<#2993#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_LAN",
tab: [
{url: "Advanced_LAN_Content.asp", tabName: "<#283#>"},
{url: "Advanced_DHCP_Content.asp", tabName: "<#284#>"},
{url: "Advanced_MultiSubnet_Content.asp", tabName: "<#284#>"},
{url: "Advanced_GWStaticRoute_Content.asp", tabName: "<#285#>"},
{url: "Advanced_IPTV_Content.asp", tabName: "IPTV"},
{url: "Advanced_SwitchCtrl_Content.asp", tabName: "<#2543#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_WAN",
tab: [
{url: "Advanced_WAN_Content.asp", tabName: "<#287#>"},
{url: "Advanced_DSL_Content.asp", tabName: "<#287#>"},
{url: "Advanced_Modem_Content.asp", tabName: "<#287#>"},
{url: "Advanced_MobileBroadband_Content.asp", tabName: "<#287#>"},
{url: "Advanced_WANPort_Content.asp", tabName: "<#171#>"},
{url: "Advanced_PortTrigger_Content.asp", tabName: "<#288#>"},
{url: "Advanced_VirtualServer_Content.asp", tabName: "<#289#>"},
{url: "Advanced_Exposed_Content.asp", tabName: "<#290#>"},
{url: "Advanced_ASUSDDNS_Content.asp", tabName: "<#291#>"},
{url: "Advanced_NATPassThrough_Content.asp", tabName: "<#319#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_VPN",
tab: [
{url: "Advanced_VPN_PPTP.asp", tabName: "<#129#>"},
{url: "Advanced_VPN_OpenVPN.asp", tabName: "__INHERIT__"},
{url: "Advanced_VPN_IPSec.asp", tabName: "__INHERIT__"},
{url: "Advanced_VPNClient_Content.asp", tabName: (vpn_fusion_support) ? "<#3341#>" : "<#2942#>"},
...
index: "menu_Firewall",
tab: [
{url: "Advanced_BasicFirewall_Content.asp", tabName: "<#276#>"},
{url: "Advanced_URLFilter_Content.asp", tabName: "<#298#>"},
{url: "Advanced_KeywordFilter_Content.asp", tabName: "<#301#>"},
{url: "Advanced_Firewall_Content.asp", tabName: "<#300#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Setting",
tab: [
{url: "Advanced_OperationMode_Content.asp", tabName: "<#304#>"},
{url: "Advanced_System_Content.asp", tabName: "<#306#>"},
{url: "Advanced_FirmwareUpgrade_Content.asp", tabName: "<#307#>"},
{url: "Advanced_SettingBackup_Content.asp", tabName: "<#308#>"},
{url: "Advanced_PerformanceTuning_Content.asp", tabName: "Performance tuning"},
{url: "Advanced_ADSL_Content.asp", tabName: "<#270#>"},
{url: "Advanced_Feedback.asp", tabName: "<#2053#>"},
...
{url: "Advanced_Privacy.asp", tabName: "<#3372#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Log",
tab: [
{url: "Main_LogStatus_Content.asp", tabName: "<#309#>"},
{url: "Main_WStatus_Content.asp", tabName: "<#311#>"},
{url: "Main_DHCPStatus_Content.asp", tabName: "<#310#>"},
{url: "Main_IPV6Status_Content.asp", tabName: "IPv6"},
{url: "Main_RouteStatus_Content.asp", tabName: "<#313#>"},
{url: "Main_IPTStatus_Content.asp", tabName: "<#312#>"},
{url: "Main_AdslStatus_Content.asp", tabName: "<#269#>"},
{url: "Main_ConnStatus_Content.asp", tabName: "<#1250#>"},
...
tab: [
{url: "Main_Analysis_Content.asp", tabName: "<#2176#>"},
{url: "Main_Netstat_Content.asp", tabName: "Netstat"},
{url: "Main_WOL_Content.asp", tabName: "<#2196#>"},
{url: "Advanced_Smart_Connect.asp", tabName: "<#2496#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
}
],
